...
(function( $ ) {
	...
	function getOption(objId) {
		...
		*/
		...
		return {
			...
			fileSizeLimit:5000 * 100 * 1024,

			fileSingleSizeLimit:500 * 100 * 1024,

			formData:{

			    contractid:"888",baoxiaoid:"999"
	...
	function createBox( $fileInput, file, webUploader ) {
		...
		if ( $parentFileBox.find('.diyButton').length <= 0 ) {
			...
			var div = "<div class='diyButton'> \<a class='diyStart' href='javascript:void(0)'>开始上传</a> \<a class='diyCancelAll' href='javascript:void(0)'>全部取消</a> \</div>";
		...
		var li = "<li id='fileBox_"+file_id+"' class='diyUploadHover'> \<div class='viewThumb'></div> \<div class='diyCancel'></div> \<div class='diySuccess'></div> \<div class='diyFileName'>"+file.name+"</div>\<div class='diyBar'> \<div class='diyProgress'></div> \<div class='diyProgressText'>0%</div> \</div> \</li>";
