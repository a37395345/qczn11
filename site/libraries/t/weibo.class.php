...
class weibo 
{
	...
	function friends_timeline($args="")
	{
		return $this->call_method( 'statuses' , 'friends_timeline', $args );
	}
	
	function user_timeline( $args="" ) 
	{
		return $this->call_method( 'statuses' , 'user_timeline' , $args );
	}
