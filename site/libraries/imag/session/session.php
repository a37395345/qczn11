...
Loader::register('SessionStorage', dirname(__FILE__).'/storage.php');
...
class Session extends Object
{
	 ...
	 *
	 * @access protected
	 * @var	object A SessionStorage object
	 */
	private $_store	=	null;
	...
	*/
	private $_security = array( 'fix_browser' );
	...
	*/
	 ...
	 * 		<pre>  $session = &Session::getInstance();</pre>
	 *
	 * @access	public
	...
	public static function getInstance($handler, $options)
	{
		...
		if (!is_object($instance)) {
			$instance = new Session($handler, $options);
		}
	...
	public function getStores()
	{
		...
		$handlers = Folder::files(dirname(__FILE__).DS.'storage', '.php$');
