...
class SimpleXML extends Object
{
	...
	*/
	 ...
	 * XSimpleXMLElement with properties containing the data held within the xml document.
	 * If any errors occur, it returns FALSE.
	 *
	 * @param string  Well-formed xml string data
	 * @param string  currently ignored
	 * @return object XSimpleXMLElement
	 */
	 ...
	 * to an object  of class XSimpleXMLElement. If any errors occur during file access or
	...
	/**
	 * Get a XSimpleXMLElement object from a DOM node.
	 *
	 ...
	 */
	private function _handleError($code, $line, $col)
	{
		throw(new Exception('SOME_ERROR_CODE,XML Parsing Error at '.$line.':'.$col.'. Error '.$code.': '.xml_error_string($code)));
	}
	 ...
	 * @param array $attrs
	 */
	private function _startElement($parser, $name, $attrs = array())
	{
		...
		if ($count == 0)
		{
			...
			$classname = "X".get_class( $this ) . 'Element';
 ...
 * 
 */
class XSimpleXMLElement extends Object
{
	/**
	 ...
	 * @param array  $attrs
	 * @param int 	 $level
	 * @return XSimpleXMLElement 	The added child object
	 */
	...
	/**
	 * traverses the tree calling the $callback( XSimpleXMLElement
	 * $this, mixed $args=array() ) function with each XSimpleXMLElement.
	 *
