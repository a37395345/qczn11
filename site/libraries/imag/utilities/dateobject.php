...
/**
 * DateTime is a class that stores a date
 *
...
class DateObject extends Object
{
	...
	/**
	 * Creates a new instance of DateTime representing a given date.
	 *
	 * Accepts RFC 822, ISO 8601 date formats as well as unix time stamps.
	 * If not specified, the current date and time is used.
	 *
	 * @param mixed $date optional the date this DateTime will represent.
	...
	/**
	 * Translates needed strings in for DateTime::toFormat (see {@link PHP_MANUAL#strftime})
	 *
	 * @access protected
	 * @param string $format The date format specification string (see {@link PHP_MANUAL#strftime})
