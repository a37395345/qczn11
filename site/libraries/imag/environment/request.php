...
class Request
{
	...
	public static function getVar($name, $hash = 'default', $type = 'none', $mask = 0)
	{
		...
		if (isset($input[$name]) && $input[$name] !== null) {
			...
			if (get_magic_quotes_gpc() && ($var != null) && ($hash != 'FILES')) {
	 ...
	 * @since	1.5
	 */
	public static function getInt($name, $hash = 'default')
	{
		return Request::getVar($name, $hash, 'int');
	}
	 ...
	 * @since	1.5
	 */
	public static function getFloat($name, $hash = 'default')
	{
		return Request::getVar($name, $hash, 'float');
	}
	 ...
	 * @since	1.5
	 */
	public static function getBool($name, $hash = 'default')
	{
		return Request::getVar($name, $hash, 'bool');
	}
	 ...
	 * @since	1.5
	 */
	public static function getWord($name, $hash = 'default')
	{
		return Request::getVar($name, $hash, 'word');
	}
	 ...
	 * @since	1.5
	 */
	public static function getCmd($name, $hash = 'default')
	{
		return Request::getVar($name, $hash, 'cmd');
	}
	 ...
	 * @since	1.5
	 */
	public static function getString($name, $hash = 'default', $mask = 0)
	{
		// Cast to string, in case JREQUEST_ALLOWRAW was specified for mask
		return (string) Request::getVar($name, $hash, 'string', $mask);
	}
	 ...
	 * get forward
	 */
	public static function getForward($key){
