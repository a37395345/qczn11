<?php /* Smarty version Smarty-3.0.4, created on 2015-10-08 15:20:13
         compiled from "D:\czyhqc\site\templates\elsker\operator/insur/create.html" */ ?>
<?php /*%%SmartyHeaderCode:141305616192d28dec8-16341605%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2cdf24452f11a9470d6ff2d993ea20cb1491cfa4' => 
    array (
      0 => 'D:\\czyhqc\\site\\templates\\elsker\\operator/insur/create.html',
      1 => 1444288393,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '141305616192d28dec8-16341605',
  'function' => 
  array (
  ),
...
" /><input type="hidden" name="shunt" id="shunt" value="" />
	  ...
	  <dl class="lineD">
	    ...
	    <dd><input type="radio" name="insurance_type" value="商业险" <?php if ((isset($_smarty_tpl->getVariable('list')->value['insurance_type']) ? $_smarty_tpl->getVariable('list')->value['insurance_type'] : null)=="商业险"){?>checked<?php }?> />商业险&nbsp;<input type="radio" name="insurance_type" value="交强险" <?php if ((isset($_smarty_tpl->getVariable('list')->value['insurance_type']) ? $_smarty_tpl->getVariable('list')->value['insurance_type'] : null)=="交强险"){?>checked<?php }?> />交强险</dd>
	  </dl>
	  <dl class="lineD">
...
"/>%</dd>
	  ...
	  <dl class="lineD" style="display:block;" id="show1_6">
	    <dt>返利：</dt>
	    <dd><input type="text" name="insurance_return" id="insurance_return" size="2" value="<?php echo (isset($_smarty_tpl->getVariable('list')->value['insurance_return']) ? $_smarty_tpl->getVariable('list')->value['insurance_return'] : null);?>
"/></dd>
	  </dl>
...
$(document).ready(function(){
    ...
    $("#insurance_money").live('input propertychange',function(){
		if ($(this).val()!=''){
		    aa=$(this).val()=="" ? 0 : parseFloat($(this).val())*0.1;
		    $("#insurance_return").val(aa);
		}
    });
