<?php /* Smarty version Smarty-3.0.4, created on 2014-08-12 16:22:24
         compiled from "D:\Phpserv\qczn\site\templates\elsker\operator/business/select.html" */ ?>
<?php /*%%SmartyHeaderCode:285753e9cec04ba6c9-60247326%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a8bd4fd6bb994facba5babf43be19ad45a8705d2' => 
    array (
      0 => 'D:\\Phpserv\\qczn\\site\\templates\\elsker\\operator/business/select.html',
      1 => 1407831650,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '285753e9cec04ba6c9-60247326',
  'function' => 
  array (
  ),
...
" value="0"/>否<input type="radio" name="result_<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['item_id']) ? $_smarty_tpl->tpl_vars['row']->value['item_id'] : null);?>
" id="result_<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['item_id']) ? $_smarty_tpl->tpl_vars['row']->value['item_id'] : null);?>
" value="1"/>是
		<?php }else{ ?>
	...
	function ok(){
        ...
        $.each($('table input:checked'), function(i, n){
			if ($(n).val()>0){
				...
				strRe+="<ul id=\"U"+nid+"\">";
				strRe+="<li><input type=\"hidden\" id=\"Rid\" name=\"Rid[]\" value=\"\" />"+nid+"<input type=\"hidden\" id=\"Cid\" name=\"Cid[]\" value=\""+nid+"\" /></li>";
				strRe+="<li>"+$('#name_'+nid).val()+"</li>";
				strRe+="<li>"+tmpmoney+"<input type=\"hidden\" id=\"money_"+nid+"\" name=\"money[]\" value=\""+tmpmoney+"\" /></li>";
				strRe+="<li>"+ (isback=="0" ? "&nbsp;" : tmpmoney)+"<input type=\"hidden\" id=\"back_money\" name=\"back_money[]\" value=\""+tmpbackmoney+"\" /></li>";
				strRe+="<li><a href=\"javascript:del("+nid+")\"><img src=\"../../../css/error.gif\" /></a><input type=\"hidden\" id=\"D"+nid+"\" name=\"Did[]\" value=\"0\" /></li></ul>";
			}
		});
	...
	function ok2(){
        ...
        $.each($('table input[name="checkbox"]:checked'), function(i, n){
			if ($(n).val()>0){
				...
				strRe+="<ul id=\"V"+nid+"\">";
				strRe+="<li><input type=\"hidden\" id=\"Recid\" name=\"Recid[]\" value=\"\" />"+nid+"<input type=\"hidden\" id=\"Iid\" name=\"Iid[]\" value=\""+nid+"\" /></li>";
				strRe+="<ll>"+$('#name_'+nid).val()+"</ll>";
				strRe+="<li>"+tmpresult+"<input type=\"hidden\" id=\"result\" name=\"result[]\" value=\""+tmpresult+"\" /></li>";
				strRe+="<li><a href=\"javascript:delV("+nid+")\"><img src=\"../../../css/error.gif\" /></a><input type=\"hidden\" id=\"DV"+nid+"\" name=\"DVid[]\" value=\"0\" /></li></ul>";
			}
		});
