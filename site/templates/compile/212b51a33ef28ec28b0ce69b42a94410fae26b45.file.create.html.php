<?php /* Smarty version Smarty-3.0.4, created on 2019-09-30 12:22:34
         compiled from "/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/maint/create.html" */ ?>
<?php /*%%SmartyHeaderCode:21057009165d91830adca922-46504783%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '212b51a33ef28ec28b0ce69b42a94410fae26b45' => 
    array (
      0 => '/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/maint/create.html',
      1 => 1569749234,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21057009165d91830adca922-46504783',
  'function' => 
  array (
  ),
...
"  /></dd>
	...
	<dl class="lineD" id="divnextdate" <?php if ((isset($_smarty_tpl->getVariable('list')->value['maintenance_type']) ? $_smarty_tpl->getVariable('list')->value['maintenance_type'] : null)!="保养"){?>style="display:none;"<?php }?>>
		<dt>下次保养日期和公里数：</dt>
...
"/>公里</dd>
	  ...
	  <dl class="lineD">
	    <dt>保养/维修内容：</dt>
	    <dd><textarea name="maintenance_remark" cols="90" rows="4"><?php echo (isset($_smarty_tpl->getVariable('list')->value['maintenance_remark']) ? $_smarty_tpl->getVariable('list')->value['maintenance_remark'] : null);?>
</textarea></dd>
	  </dl>
	  <dl class="lineD" >
	    <dt>具体内容</dt>
...
?>
	    <tr>
	    <td><input type="hidden" name="item[]" value="<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['option_id']) ? $_smarty_tpl->tpl_vars['row']->value['option_id'] : null);?>
" /> <input type="checkbox" value="1" name="maintenance_check_<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['option_id']) ? $_smarty_tpl->tpl_vars['row']->value['option_id'] : null);?>
" <?php $_tmp1=(isset($_smarty_tpl->tpl_vars['row']->value['item_id']) ? $_smarty_tpl->tpl_vars['row']->value['item_id'] : null);?><?php if (!empty($_tmp1)){?>checked<?php }?>/><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['option_name']) ? $_smarty_tpl->tpl_vars['row']->value['option_name'] : null);?>
</td>
	    <td><input type="text" name="maintenance_nextdate_<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['option_id']) ? $_smarty_tpl->tpl_vars['row']->value['option_id'] : null);?>
" id="maintenance_nextdate_<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['option_id']) ? $_smarty_tpl->tpl_vars['row']->value['option_id'] : null);?>
" size="8" value="<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['next_date']) ? $_smarty_tpl->tpl_vars['row']->value['next_date'] : null);?>
" onclick="calendar.show(this);" />/<input type="text" name="maintenance_nextkilo_<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['option_id']) ? $_smarty_tpl->tpl_vars['row']->value['option_id'] : null);?>
" id="maintenance_nextkilo_<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['option_id']) ? $_smarty_tpl->tpl_vars['row']->value['option_id'] : null);?>
" size="3" value="<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['next_kilo']) ? $_smarty_tpl->tpl_vars['row']->value['next_kilo'] : null);?>
"/>公里</td>
	    <td><textarea name="maintenance_remark_<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['option_id']) ? $_smarty_tpl->tpl_vars['row']->value['option_id'] : null);?>
" cols="50" rows="2"><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['remark']) ? $_smarty_tpl->tpl_vars['row']->value['remark'] : null);?>
</textarea></td>
	    </tr>
	    <?php }} ?>
	    </table>
