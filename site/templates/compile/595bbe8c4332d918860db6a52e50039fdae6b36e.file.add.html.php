<?php /* Smarty version Smarty-3.0.4, created on 2019-10-14 14:04:38
         compiled from "/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/zhiwei/add.html" */ ?>
<?php /*%%SmartyHeaderCode:3865335055da40ff6279fb5-33250567%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '595bbe8c4332d918860db6a52e50039fdae6b36e' => 
    array (
      0 => '/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/zhiwei/add.html',
      1 => 1571030102,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3865335055da40ff6279fb5-33250567',
  'function' => 
  array (
  ),
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>添加职位<<?php ?>?php echo "123";?<?php ?>></h5>
...
">
                        ...
                        <tr>
                            <th style="background-color:#F5F5F6" width="15%">
                             ...
                             <td width="35%">
                                <input type="text" id="zhize" name="zhize"  class="form-control input-sm" placeholder="岗位职责" minlength="1" maxlength="28">
                            </td>
                            <th style="background-color:#F5F5F6" width="15%">
                                <span style="color:#000">星级：</span>
                            </th>
                            <td width="35%">
                                <input required id="input-21c" value="0" type="text" title="" name="xingji">
                            </td>
