<?php /* Smarty version Smarty-3.0.4, created on 2019-10-17 14:07:12
         compiled from "/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/zijia_linshi/zijia_changecar_a.html" */ ?>
<?php /*%%SmartyHeaderCode:11634919775da80510033990-84099711%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '692231f070faa17288481535a6315764af3bbfa6' => 
    array (
      0 => '/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/zijia_linshi/zijia_changecar_a.html',
      1 => 1571292163,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11634919775da80510033990-84099711',
  'function' => 
  array (
  ),
...
" name="etime">
									...
									<tr>
										...
										<td width="35%">
											<input type="number" min="0" class="form-control input-sm" placeholder="必填" id="ekm"  name="ekm" >
										</td>
									</tr>
...
" size="10"/>
									...
									<tr >
										...
										<td width="35%">
											<input type="number" min="0" id="plan_rentamounta" class="form-control input-sm" placeholder="" <?php if ((isset($_smarty_tpl->getVariable('paiche')->value['paiche_pintaiid']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_pintaiid'] : null)<=0){?>readonly="readonly" unselectable="on"<?php }?> >
										</td>
...
">
										...
										<td width="35%">
											<input type="number" min="0" id="yajin_a" class="form-control input-sm" placeholder="" name="yajin_a">
										</td>
									</tr>
									...
									<tr>
										...
										<td width="35%">
											<input type="number" min="0" id="zujin_a" class="form-control input-sm" placeholder="" <?php if ((isset($_smarty_tpl->getVariable('paiche')->value['paiche_pintaiid']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_pintaiid'] : null)==0){?>readonly="readonly" unselectable="on"<?php }?> name="zujin_a">
										</td>
										<th style="background-color:#F5F5F6" width="15%">
