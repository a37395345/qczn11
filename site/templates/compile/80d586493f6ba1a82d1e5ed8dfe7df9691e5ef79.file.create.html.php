<?php /* Smarty version Smarty-3.0.4, created on 2014-09-12 13:46:22
         compiled from "D:\Phpserv\qczn\site\templates\elsker\operator/machine/create.html" */ ?>
<?php /*%%SmartyHeaderCode:9634541288ae0e35e7-96788695%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '80d586493f6ba1a82d1e5ed8dfe7df9691e5ef79' => 
    array (
      0 => 'D:\\Phpserv\\qczn\\site\\templates\\elsker\\operator/machine/create.html',
      1 => 1410500568,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9634541288ae0e35e7-96788695',
  'function' => 
  array (
  ),
...
" /></dd>
	  ...
	  <dl class="lineD">
	    <dt><span class="redstar">*</span>购车日期：</dt>
...
"/>元</dd>
	  ...
	  <dl class="lineD">
	    <dt><span class="redstar">*</span>上牌日期：</dt>
...
" onclick="calendar.show(this);" readonly="readonly" /></dd>
	  ...
	  <dl class="lineD">
	    <dt>是否安装定位系统：</dt>
	    <dd><input type='checkbox' name='car_position' <?php if ((isset($_smarty_tpl->getVariable('list')->value['car_position']) ? $_smarty_tpl->getVariable('list')->value['car_position'] : null)==1){?>checked="checked"<?php }?> value="1" /></dd>
	  </dl>
	  <dl class="lineD">
	  	<dt>定位系统安装日期：</dt>
	    <dd><input type="text" name="car_positionDate" size="16" value="<?php echo (isset($_smarty_tpl->getVariable('list')->value['car_positionDate']) ? $_smarty_tpl->getVariable('list')->value['car_positionDate'] : null);?>
" onclick="calendar.show(this);" readonly="readonly" /></dd>
	  
	  </dl>  
	  <dl class="lineD">
	    <dt>是否有导航仪：</dt>
	    <dd><input type='checkbox' name='car_nav' <?php if ((isset($_smarty_tpl->getVariable('list')->value['car_nav']) ? $_smarty_tpl->getVariable('list')->value['car_nav'] : null)==1){?>checked="checked"<?php }?> value="1" /></dd>
	  </dl>
	  <dl class="lineD">
	    <dt>状态：</dt>
	    <dd><select name="car_status">
	    <option value="0" <?php if ((isset($_smarty_tpl->getVariable('list')->value['car_status']) ? $_smarty_tpl->getVariable('list')->value['car_status'] : null)=="0"){?> selected<?php }?>>空闲</option>
	    <option value="1" <?php if ((isset($_smarty_tpl->getVariable('list')->value['car_status']) ? $_smarty_tpl->getVariable('list')->value['car_status'] : null)=="1"){?> selected<?php }?>>租用</option>
	    <option value="2" <?php if ((isset($_smarty_tpl->getVariable('list')->value['car_status']) ? $_smarty_tpl->getVariable('list')->value['car_status'] : null)=="2"){?> selected<?php }?>>维修</option>
	    </select></dd>
	  </dl>
	  <dl class="lineD">
	      <dt>车辆照片：</dt>
	      <dd>照片一<input type="file" name="images1" value=""/><br />照片二<input type="file" name="images2" value=""/><br />
	        	...
	        	照片五<input type="file" name="images5" value=""/><br />照片六<input type="file" name="images6" value=""/>
