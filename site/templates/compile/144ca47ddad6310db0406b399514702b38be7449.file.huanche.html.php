<?php /* Smarty version Smarty-3.0.4, created on 2019-12-10 14:42:42
         compiled from "D:\WWW\qczn\site\templates\elsker\operator/changqi_zijia/huanche.html" */ ?>
<?php /*%%SmartyHeaderCode:187395def3e6216c027-27118763%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '144ca47ddad6310db0406b399514702b38be7449' => 
    array (
      0 => 'D:\\WWW\\qczn\\site\\templates\\elsker\\operator/changqi_zijia/huanche.html',
      1 => 1575960136,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '187395def3e6216c027-27118763',
  'function' => 
  array (
  ),
...
" name="etime">
									...
									<tr>
										...
										<td width="35%">
											<input type="text" min="0" class="form-control input-sm" placeholder="必填" id="skm" name="skm" readonly="readonly" unselectable="on" value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['settle_startKm']) ? $_smarty_tpl->getVariable('paiche')->value['settle_startKm'] : null);?>
">
										</td>
										...
										<td width="35%">
											<input type="text" min="0" class="form-control input-sm" placeholder="必填" id="ekm"  name="ekm">
										</td>
									</tr>
...
" >
										...
										<th style="background-color:#F5F5F6" width="15%">
											<span style="color:#000">被换车辆起始公里</span>
										</th>
										<td width="35%">
											<input type="text" min="0" class="form-control input-sm" placeholder="必填" id="ekm_a"  name="ekm_a">
										</td>
									</tr>
									</table>
								</div>
								...
								<div class="shiji">
									...
									<tr>
										<th style="background-color:#F5F5F6" width="15%">
											<span style="color:#000">原租金(租金+续租金+租金差价-优惠)：</span>
										</th>
										<td width="35%">
											<input type="text" id="" class="form-control input-sm" placeholder="" name="zujin_a" value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['zhujin']) ? $_smarty_tpl->getVariable('paiche')->value['zhujin'] : null)+(isset($_smarty_tpl->getVariable('paiche')->value['xzhujin']) ? $_smarty_tpl->getVariable('paiche')->value['xzhujin'] : null)+(isset($_smarty_tpl->getVariable('paiche')->value['zhujin_chajia']) ? $_smarty_tpl->getVariable('paiche')->value['zhujin_chajia'] : null)-(isset($_smarty_tpl->getVariable('paiche')->value['youhui']) ? $_smarty_tpl->getVariable('paiche')->value['youhui'] : null);?>
" readonly="readonly" unselectable="on">
										</td>
										<th style="background-color:#F5F5F6" width="15%">
											<span style="color:#000">换车后租金：</span>
										</th>
										<td width="35%">
											<input type="text" onkeyup="value=value.replace(/[^\d.]/g,'')" id="zujin" name="zujin" value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['zhujin']) ? $_smarty_tpl->getVariable('paiche')->value['zhujin'] : null)+(isset($_smarty_tpl->getVariable('paiche')->value['xzhujin']) ? $_smarty_tpl->getVariable('paiche')->value['xzhujin'] : null)+(isset($_smarty_tpl->getVariable('paiche')->value['zhujin_chajia']) ? $_smarty_tpl->getVariable('paiche')->value['zhujin_chajia'] : null)-(isset($_smarty_tpl->getVariable('paiche')->value['youhui']) ? $_smarty_tpl->getVariable('paiche')->value['youhui'] : null);?>
