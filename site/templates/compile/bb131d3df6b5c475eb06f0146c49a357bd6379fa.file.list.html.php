<?php /* Smarty version Smarty-3.0.4, created on 2019-09-30 13:43:34
         compiled from "/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/finance/baoxiao/list.html" */ ?>
<?php /*%%SmartyHeaderCode:17424026155d919606ed84a7-02570086%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bb131d3df6b5c475eb06f0146c49a357bd6379fa' => 
    array (
      0 => '/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/finance/baoxiao/list.html',
      1 => 1569822210,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17424026155d919606ed84a7-02570086',
  'function' => 
  array (
  ),
...
" name="search_startDate" onClick="calendar.show(this);">到
  ...
  <tr>
	...
	<?php }?>
	<th>报销单号</th>
	<?php if ($_smarty_tpl->getVariable('item')->value==1){?><th>合同号<hr/>用车时间</th><?php }?>
	...
	<th width="5%">报销人</th>
	<?php if ($_smarty_tpl->getVariable('item')->value==2){?><th width="7%">报销金额</th><?php }?>
	<?php if ($_smarty_tpl->getVariable('item')->value==2){?><th width="8%">费用类型</th><?php }?>
	<?php if ($_smarty_tpl->getVariable('item')->value==2){?><th width="5%">店铺</th><?php }?>
	<?php if ($_smarty_tpl->getVariable('item')->value==1){?><th width="15%">报销备注</th><?php }?>
	<th width="8%">报销日期</th>
...
"></td>
	<?php }?>
	<td><a href="detail.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['baoxiao_id']) ? $_smarty_tpl->tpl_vars['row']->value['baoxiao_id'] : null);?>
...
" target="_blank"><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['baoxiaoPaicheContractNum']) ? $_smarty_tpl->tpl_vars['row']->value['baoxiaoPaicheContractNum'] : null);?>
	...
	<hr/><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_startDate']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_startDate'] : null);?>
~~<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_endDate']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_endDate'] : null);?>
	...
	<?php if ($_smarty_tpl->getVariable('item')->value==2){?><td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['baoxiao_type']) ? $_smarty_tpl->tpl_vars['row']->value['baoxiao_type'] : null);?>
</td><?php }?>
	<?php if ($_smarty_tpl->getVariable('item')->value==2){?><td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['shop_name']) ? $_smarty_tpl->tpl_vars['row']->value['shop_name'] : null);?>
</td><?php }?>
	<?php if ($_smarty_tpl->getVariable('item')->value==1){?><td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['baoxiao_remarks']) ? $_smarty_tpl->tpl_vars['row']->value['baoxiao_remarks'] : null);?>
</td><?php }?>
...
" target="_blank">明细</a>
	...
	<?php if ((isset($_smarty_tpl->tpl_vars['row']->value['baoxiao_isAgree']) ? $_smarty_tpl->tpl_vars['row']->value['baoxiao_isAgree'] : null)==0||(isset($_smarty_tpl->tpl_vars['row']->value['baoxiao_isAgree']) ? $_smarty_tpl->tpl_vars['row']->value['baoxiao_isAgree'] : null)==-1){?>
