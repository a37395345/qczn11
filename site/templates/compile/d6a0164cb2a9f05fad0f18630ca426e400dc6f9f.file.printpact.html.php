<?php /* Smarty version Smarty-3.0.4, created on 2019-04-29 11:05:21
         compiled from "F:\WWW\qczn\site\templates\elsker\operator/business/printpact.html" */ ?>
<?php /*%%SmartyHeaderCode:263985cc669f18dd287-81714344%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd6a0164cb2a9f05fad0f18630ca426e400dc6f9f' => 
    array (
      0 => 'F:\\WWW\\qczn\\site\\templates\\elsker\\operator/business/printpact.html',
      1 => 1556507114,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '263985cc669f18dd287-81714344',
  'function' => 
  array (
  ),
...
<?php }?></p></td>
  ...
  <tr>
    ...
    <td width="44%" colspan="3"><p><?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_promierNum']) ? $_smarty_tpl->getVariable('list')->value['paiche_promierNum'] : null);?>
</p></td>
    <td><p>电话</p></td>
    <td><p><?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_promierPhone']) ? $_smarty_tpl->getVariable('list')->value['paiche_promierPhone'] : null);?>
</p></td>
  </tr>
</table>
...
元/辆，在租车时一次性以现金方式缴付给甲方。还车时，在车辆完好无损的情况下凭押金手据与甲方结算，<font style="font-family : 微软雅黑,宋体;text-decoration:underline;"><strong>结算时甲方要暂扣违章保证金3000元，在30天后退回，所有违章由本公司统一处理，结算方式为：违章费用+50%违章手续费+150元/分，结算时间为银行营业时间内。</strong></font> <br />
...
，若超出范围，租车公司将前往收车，押金不退！收车费另算。<?php if ((isset($_smarty_tpl->getVariable('list')->value['paiche_needtax']) ? $_smarty_tpl->getVariable('list')->value['paiche_needtax'] : null)==0){?>此次租车不需要开票。<?php }?>如若提前还车，租金不退。还车时清洗车辆，如若不洗，支付50元清洗费给甲方。租赁期间保管好车辆行驶证，如果丢失，赔偿500元。</strong></font><br />
...
<?php }?>
  ...
  2．合同的附件是本合同的组成部分，与本合同具有同等法律效力。 <br />
  3．如发生纠纷，由甲乙双方协商解决，协商不成，提交甲方所在的人民法院求得解决。 <br />
  4．本合同一式二份，甲，乙双方各执一份。本合同经甲，乙双方签字或盖章后生效。</p>
<p>甲方（盖章）：             　　　　　　　　                   乙方（盖章）：<br />
  代理人（签字）：            　　　　　　　　              担保人（签字或盖章）：<br />
  日期： 　                  　　　　　　　　　                  日期：<br />
  签约地点： </p>
...
<table border="1" cellspacing="0" cellpadding="0" width="100%" class="table" style="text-align:center;border:#c4c4c4 solid 1px;line-height:0px;">
  ...
  <tr>
    ...
    <td width="624" colspan="14" align="left" style="line-height:20px;"><b>油箱为满油。客户在归还车辆时必须将车辆内外清洗干净，否则将加收50元清洗费用。</b><br />
      <b>凭此单据在还车30日后退还相应违章保证金，交接单如有丢失，恕不退还违章保证金。</b></td>
  </tr>
</table>
