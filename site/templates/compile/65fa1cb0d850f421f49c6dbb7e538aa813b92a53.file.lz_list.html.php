<?php /* Smarty version Smarty-3.0.4, created on 2019-04-01 09:54:15
         compiled from "F:\WWW\qczn\site\templates\elsker\operator/business/lz_list.html" */ ?>
<?php /*%%SmartyHeaderCode:35805ca16f47282134-66321095%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '65fa1cb0d850f421f49c6dbb7e538aa813b92a53' => 
    array (
      0 => 'F:\\WWW\\qczn\\site\\templates\\elsker\\operator/business/lz_list.html',
      1 => 1554083638,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '35805ca16f47282134-66321095',
  'function' => 
  array (
  ),
...
<?php }?><hr /><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['client_name']) ? $_smarty_tpl->tpl_vars['row']->value['client_name'] : null);?>
        ...
        <td><?php if ((isset($_smarty_tpl->tpl_vars['row']->value['show_tip']) ? $_smarty_tpl->tpl_vars['row']->value['show_tip'] : null)==1&&$_smarty_tpl->getVariable('op')->value==''&&($_smarty_tpl->getVariable('busitype')->value=='1'||$_smarty_tpl->getVariable('busitype')->value=='2')){?><div class="tixing">此单已超过合同时间，但是还未还车，请及时处理！</div><?php }?>
...
" target="_blank">明细</a><?php }else{ ?>明细<?php }?>
 ...
 <tr>
    <td colspan="20" style="text-align:left;"><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_line']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_line'] : null);?>
