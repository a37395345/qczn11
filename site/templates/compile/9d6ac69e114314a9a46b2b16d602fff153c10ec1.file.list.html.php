<?php /* Smarty version Smarty-3.0.4, created on 2014-09-29 13:19:33
         compiled from "D:\Phpserv\qczn\site\templates\elsker\operator/finance/baoxiao/list.html" */ ?>
<?php /*%%SmartyHeaderCode:284425428ebe5f3aeb9-77446874%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9d6ac69e114314a9a46b2b16d602fff153c10ec1' => 
    array (
      0 => 'D:\\Phpserv\\qczn\\site\\templates\\elsker\\operator/finance/baoxiao/list.html',
      1 => 1411967968,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '284425428ebe5f3aeb9-77446874',
  'function' => 
  array (
  ),
...
条记录&nbsp;&nbsp;&nbsp;<?php echo $_smarty_tpl->getVariable('PAGINATION')->value;?>
    ...
    <a href="javascript:void(0);" class="btn_a" onclick="add();"><span>添加</span></a><?php }?>
...
<br /><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_endDate']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_endDate'] : null);?>
	...
	<?php if ($_smarty_tpl->getVariable('op')->value!="check"){?>
	<td><?php if ((isset($_smarty_tpl->tpl_vars['row']->value['baoxiao_isAgree']) ? $_smarty_tpl->tpl_vars['row']->value['baoxiao_isAgree'] : null)==0){?>未审核<?php }else{ ?><?php if ((isset($_smarty_tpl->tpl_vars['row']->value['baoxiao_isAgree']) ? $_smarty_tpl->tpl_vars['row']->value['baoxiao_isAgree'] : null)==-1){?>审核未通过<?php }else{ ?>审核通过<?php }?><hr /><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['baoxiao_isAgreeMan']) ? $_smarty_tpl->tpl_vars['row']->value['baoxiao_isAgreeMan'] : null);?>
