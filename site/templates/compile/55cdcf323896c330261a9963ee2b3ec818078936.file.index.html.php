<?php /* Smarty version Smarty-3.0.4, created on 2019-10-11 19:00:17
         compiled from "/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/department/index.html" */ ?>
<?php /*%%SmartyHeaderCode:6972533585da060c1100b83-06737585%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '55cdcf323896c330261a9963ee2b3ec818078936' => 
    array (
      0 => '/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/department/index.html',
      1 => 1570789017,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6972533585da060c1100b83-06737585',
  'function' => 
  array (
  ),
    ...
    <div class="row wrapper wrapper-content animated fadeInRight">
        <div class="col-sm-12">
            <div class="ibox float-e-margins" >
                ...
                <?php if ($_smarty_tpl->getVariable('department_add')->value==1){?>
               <div class="ibox-tools" style="float: left;margin-left: 40px">
                ...
                <?php }?>
                <?php if ($_smarty_tpl->getVariable('department_delete')->value==1){?>
...
?>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['department_order']) ? $_smarty_tpl->tpl_vars['rows']->value['department_order'] : null);?>

                                </td>
                                <td style="text-align: center;">
                                    <?php if ($_smarty_tpl->getVariable('department_setStatus')->value==1){?>
                                ...
                                <td style="text-align: center;">
                                    <?php if ($_smarty_tpl->getVariable('department_edit')->value==1){?>
                                    <a  href="javascript:;" onclick="edit(<?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['id']) ? $_smarty_tpl->tpl_vars['rows']->value['id'] : null);?>
);return false" target="_blank">
                                            修改</a>&nbsp;&nbsp;&nbsp;
                                            <?php }?>
                                    <?php if ($_smarty_tpl->getVariable('department_setRule')->value==1){?>
                                    <a  href="javascript:;" onclick="setRule(<?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['id']) ? $_smarty_tpl->tpl_vars['rows']->value['id'] : null);?>
);return false" target="_blank">
                                            权限</a>
                                            <?php }?>
                                </td>
...
?>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <?php echo (isset($_smarty_tpl->tpl_vars['rows_a']->value['department_order']) ? $_smarty_tpl->tpl_vars['rows_a']->value['department_order'] : null);?>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <a  href="javascript:;" onclick="edit(<?php echo (isset($_smarty_tpl->tpl_vars['rows_a']->value['id']) ? $_smarty_tpl->tpl_vars['rows_a']->value['id'] : null);?>
                                            ...
                                            <?php }?>
                                             <?php if ($_smarty_tpl->getVariable('department_setRule')->value==1){?>
                                        <a  href="javascript:;" onclick="setRule(<?php echo (isset($_smarty_tpl->tpl_vars['rows_a']->value['id']) ? $_smarty_tpl->tpl_vars['rows_a']->value['id'] : null);?>
);return false" target="_blank">
                                            权限</a>
                                            <?php }?>
                                    </td>
...
?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <?php echo (isset($_smarty_tpl->tpl_vars['rows_b']->value['department_order']) ? $_smarty_tpl->tpl_vars['rows_b']->value['department_order'] : null);?>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <?php }?>
                                            <?php if ($_smarty_tpl->getVariable('department_setRule')->value==1){?>
                                            <a  href="javascript:;" onclick="setRule(<?php echo (isset($_smarty_tpl->tpl_vars['rows_b']->value['id']) ? $_smarty_tpl->tpl_vars['rows_b']->value['id'] : null);?>
);return false" target="_blank">
                                            权限</a>
                                            <?php }?>
                                        </td>
...
<script>
    function add(){
        //alert('aa');
         demo_iframe('index.php?task=add','添加部门',1000,500,'login_js');

    }
    function edit(id){
        demo_iframe('index.php?task=edit&id='+id,'修改部门',1000,500,'login_js');

    }
    function setRule(id){
        demo_iframe('index.php?task=setRule&id='+id,'部门权限管理',1000,500,'login_js');
