<?php /* Smarty version Smarty-3.0.4, created on 2018-07-28 13:57:50
         compiled from "D:\web\site\templates\elsker\operator/business/create.html" */ ?>
<?php /*%%SmartyHeaderCode:92515b5c05de896043-67243632%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '256a1fb9f1cd4e7b0c8cbeb3b1e1d17366097c9f' => 
    array (
      0 => 'D:\\web\\site\\templates\\elsker\\operator/business/create.html',
      1 => 1531551376,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '92515b5c05de896043-67243632',
  'function' => 
  array (
  ),
...
" <?php if (strstr($_smarty_tpl->getVariable('a_permissions')->value,'inputidcard')){?><?php }else{ ?>onFocus="this.blur()"<?php }?>/>&nbsp;<input type="button" value="开始读卡" name="beginread" onClick="beginread_onclick()">&nbsp;<input type="button" value="停止读卡" name="endread"   onclick="endread_onclick()"  >
