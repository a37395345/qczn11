<?php /* Smarty version Smarty-3.0.4, created on 2014-07-10 14:15:56
         compiled from "D:\Phpserv\qczn\site\templates\elsker\operator/business/printpact.html" */ ?>
<?php /*%%SmartyHeaderCode:699553be2f9c454400-39337436%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b343b181a183e584bd17918fdf278645f7dfd841' => 
    array (
      0 => 'D:\\Phpserv\\qczn\\site\\templates\\elsker\\operator/business/printpact.html',
      1 => 1404972932,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '699553be2f9c454400-39337436',
  'function' => 
  array (
  ),
...
元。<?php echo ((isset($_smarty_tpl->getVariable('list')->value['paiche_endDate']) ? $_smarty_tpl->getVariable('list')->value['paiche_endDate'] : null)-(isset($_smarty_tpl->getVariable('list')->value['paiche_startDate']) ? $_smarty_tpl->getVariable('list')->value['paiche_startDate'] : null))/86400;?>
日限行驶里程为<?php if ((isset($_smarty_tpl->getVariable('list')->value['paiche_unlimitKm']) ? $_smarty_tpl->getVariable('list')->value['paiche_unlimitKm'] : null)=="Y"){?>不限<?php }else{ ?><?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_limitKm']) ? $_smarty_tpl->getVariable('list')->value['paiche_limitKm'] : null);?>
...
元/小时计算，（超时半小时内不计算，超半小时不满一小时按半小时计算，超一小时不满一个半小时按一小时计算） <br />
  其他约定事项 <br />
  四．车辆交接：甲方公司经营场地。 <br />
  五．缴费结算：乙方向甲方缴付定金为<?php echo $_smarty_tpl->getVariable('paiche_front')->value;?>
元，预付租金为<?php echo $_smarty_tpl->getVariable('paiche_rented')->value;?>
元，乙方需向甲方交纳租用车辆的押金为<?php echo $_smarty_tpl->getVariable('paiche_deposit')->value;?>
元/辆，在租车时一次性以现金方式缴付给甲方。还车时，在车辆完好无损的情况下凭押金手据与甲方结算，结算时甲方要暂扣违章保证金2000元，在20天后退回，结算时间为银行营业时间内。 <br />
  六．续租方式：在租赁期内，乙方需要续租，在本合同租期结束前24小时通知甲方，经甲方同意后，双方重新签订合同后才能续租。否则，甲方有权以超时作出处理。 <br />
  七．租车费用：车船税，年检费，国家强制投保险种由甲方负担，其他行驶费用由乙方承担。 <br />
  八．保养维护：乙方租用甲方的车辆后，需对所租用的车辆进行日常保养（其保养项目为：出车前的检查，途中检查，回场后的保养）。定程保养及大修，由乙方根据里程和车辆的性能状况反馈给甲方，甲方确定有必要定程保养或大修时，乙方应将车辆交给甲方，由甲方负责保养及大修。 <br />
  九．其他： <br />
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" class="table">
  ...
  <tr>
    ...
    <td width="624" colspan="14" align="left"><p><b>油箱为满油。客户在归还车辆时必须将车辆内外清洗干净，否则将加收50元清洗费用。</b><br />
      <b>凭此单据在还车20日后退还相应违章保证金，交接单如有丢失，恕不退还违章保证金。</b></p></td>
  </tr>
</table>
