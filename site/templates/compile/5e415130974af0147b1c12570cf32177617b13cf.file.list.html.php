<?php /* Smarty version Smarty-3.0.4, created on 2015-09-06 15:18:27
         compiled from "D:\czyhqc\site\templates\elsker\operator/maint/list.html" */ ?>
<?php /*%%SmartyHeaderCode:2188455ebe8c31b9592-96787204%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5e415130974af0147b1c12570cf32177617b13cf' => 
    array (
      0 => 'D:\\czyhqc\\site\\templates\\elsker\\operator/maint/list.html',
      1 => 1441517806,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2188455ebe8c31b9592-96787204',
  'function' => 
  array (
  ),
...
条记录&nbsp;&nbsp;&nbsp;<?php echo $_smarty_tpl->getVariable('PAGINATION')->value;?>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th width="10%" rowspan="2">车牌号</th>
    <th width="15%" rowspan="2">品牌</th>
    <th width="10%" rowspan="2">购买日期</th>
	<th width="18%" colspan="2">上次保养</th>
    <th width="24%" colspan="3">最近更换</th>
    <th rowspan="2">维修保养记录</th>
  </tr>
  <tr>
    <th width="10%">时间</th>
	<th width="8%">公里数</th>
...
">
	    ...
	    <td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['car_changebattery']) ? $_smarty_tpl->tpl_vars['row']->value['car_changebattery'] : null);?>
</td>
	    <td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['car_changeantifreeze']) ? $_smarty_tpl->tpl_vars['row']->value['car_changeantifreeze'] : null);?>
</td>
	    <td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['car_changebrakefluid']) ? $_smarty_tpl->tpl_vars['row']->value['car_changebrakefluid'] : null);?>
</td>
...
" style="display:none;">
 	...
 	<td colspan="8">
	    ...
	    <tr>
		    <th width="4%" style="background-color:#F3EF86;">类型</th>
		    <th width="5%" style="background-color:#F3EF86;">金额</th>
		    <th width="8%" style="background-color:#F3EF86;">日期</th>
		    <th width="5%" style="background-color:#F3EF86;">公里数</th>
		    <th  style="background-color:#F3EF86;">保养内容</th>
		    <th width="13%" style="background-color:#F3EF86;">变速箱油保养</th>
		    <th width="13%" style="background-color:#F3EF86;">皮带保养</th>
		    <th width="13%" style="background-color:#F3EF86;">发动机变速箱轮胎保养</th>
		    <th width="4%" style="background-color:#F3EF86;">更换电瓶</th>
		    <th width="4%" style="background-color:#F3EF86;">换防冻液</th>
		    <th width="4%" style="background-color:#F3EF86;">换刹车油</th>
			<th width="7%" style="background-color:#F3EF86;">操作</th>
	    </tr>
...
?>
	    <tr>
		    ...
		    <td><?php echo (isset($_smarty_tpl->tpl_vars['row1']->value['maintenance_transmission']) ? $_smarty_tpl->tpl_vars['row1']->value['maintenance_transmission'] : null);?>
</td>
		    <td><?php echo (isset($_smarty_tpl->tpl_vars['row1']->value['maintenance_belt']) ? $_smarty_tpl->tpl_vars['row1']->value['maintenance_belt'] : null);?>
</td>
		    <td><?php echo (isset($_smarty_tpl->tpl_vars['row1']->value['maintenance_engine']) ? $_smarty_tpl->tpl_vars['row1']->value['maintenance_engine'] : null);?>
</td>
		    <td><?php if ((isset($_smarty_tpl->tpl_vars['row1']->value['maintenance_changebattery']) ? $_smarty_tpl->tpl_vars['row1']->value['maintenance_changebattery'] : null)==1){?>√<?php }?></td>
		    <td><?php if ((isset($_smarty_tpl->tpl_vars['row1']->value['maintenance_changeantifreeze']) ? $_smarty_tpl->tpl_vars['row1']->value['maintenance_changeantifreeze'] : null)==1){?>√<?php }?></td>
		    <td><?php if ((isset($_smarty_tpl->tpl_vars['row1']->value['maintenance_changebrakefluid']) ? $_smarty_tpl->tpl_vars['row1']->value['maintenance_changebrakefluid'] : null)==1){?>√<?php }?></td>
...
">编辑</a>&nbsp;<a href="javascript:if(confirm('是否确定删除该记录？')){window.location.href='delete.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row1']->value['maintenance_id']) ? $_smarty_tpl->tpl_vars['row1']->value['maintenance_id'] : null);?>
';}">删除</a>
 		</tr>
	    <?php }} ?>
	    </table>
