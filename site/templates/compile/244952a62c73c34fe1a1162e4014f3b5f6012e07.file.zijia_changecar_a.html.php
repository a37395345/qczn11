<?php /* Smarty version Smarty-3.0.4, created on 2020-03-20 17:42:01
         compiled from "D:\WWW\qczn\site\templates\elsker\operator/zijia_linshi/zijia_changecar_a.html" */ ?>
<?php /*%%SmartyHeaderCode:219185e748fe9c585b6-81589306%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '244952a62c73c34fe1a1162e4014f3b5f6012e07' => 
    array (
      0 => 'D:\\WWW\\qczn\\site\\templates\\elsker\\operator/zijia_linshi/zijia_changecar_a.html',
      1 => 1584697316,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '219185e748fe9c585b6-81589306',
  'function' => 
  array (
  ),
...
" name="etime">
									...
									<tr>
										...
										<td width="35%">
											<input type="text" class="form-control input-sm"  id="beizu" name="beizu" placeholder="换车备注" >
										</td>
...
" size="10"/>
									...
									<tr >
										...
										<td width="35%">
											<input type="number" min="0" id="plan_rentamounta" class="form-control input-sm" placeholder="" <?php if ((isset($_smarty_tpl->getVariable('paiche')->value['paiche_kehu']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_kehu'] : null)==1||(isset($_smarty_tpl->getVariable('paiche')->value['paiche_kehu']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_kehu'] : null)==5){?>readonly="readonly" unselectable="on"<?php }?> >
										</td>
...
">
									...
									<tr>
										...
										<td width="35%">
											<input type="number" min="0" id="zujin_a" class="form-control input-sm" placeholder="" <?php if ((isset($_smarty_tpl->getVariable('paiche')->value['paiche_kehu']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_kehu'] : null)==1||(isset($_smarty_tpl->getVariable('paiche')->value['paiche_kehu']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_kehu'] : null)==5){?>readonly="readonly" unselectable="on"<?php }?> name="zujin_a">
										</td>
										<th style="background-color:#F5F5F6" width="15%">
