<?php /* Smarty version Smarty-3.0.4, created on 2019-09-17 18:08:54
         compiled from "F:\WWW\qczn\site\templates\elsker\operator/zijia_linshi/zijia_qita.html" */ ?>
<?php /*%%SmartyHeaderCode:208715d80b0b63a3ec4-15611096%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '45597c313f4b19d286947012f1adb1178c9c5107' => 
    array (
      0 => 'F:\\WWW\\qczn\\site\\templates\\elsker\\operator/zijia_linshi/zijia_qita.html',
      1 => 1568714927,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '208715d80b0b63a3ec4-15611096',
  'function' => 
  array (
  ),
...
" id="paiche_needtax">
								...
								<div class="shiji">
									...
									<tr>
										...
										<td width="25%">
											<input type="text"  class="form-control input-sm" name="qingxi" id="qingxi" onchange="jisuan()">
										</td>
										...
										<td width="25%">
											<input type="text"  class="form-control input-sm" name="weixiu" id="weixiu" onchange="jisuan()">
										</td>
									</tr>
									...
									<tr>
										...
										<td width="25%">
											<input type="text"  class="form-control input-sm" name="shouche" id="shouche" onchange="jisuan()">
										</td>
										<th style="background-color:#F5F5F6" width="25%">
											<span style="color:#000">刷卡费：<span style="color:#9c9696">(信用卡为刷卡金额的千分之6，储蓄卡20元)</span></span>
										</th>
										<td width="25%">
											<input type="text"  class="form-control input-sm" name="shuaka" id="shuaka" onchange="jisuan()">
										</td>
									...
									<tr>
										...
										<td width="25%">
											<input type="text"  class="form-control input-sm" name="yaoshi" id="yaoshi" onchange="jisuan()">
										</td>
										<th style="background-color:#F5F5F6" width="25%">
											<span style="color:#000">代加油服务费：<span style="color:#9c9696">(规定50元/次)</span></span>
										</th>
										<td width="25%">
											<input type="text"  class="form-control input-sm" name="fuwu" id="fuwu" placeholder="" onchange="jisuan()">
										</td>
									...
									<tr>
										...
										<td width="25%">
											<input type="text"  class="form-control input-sm" name="xingshi" id="xingshi" placeholder="" onchange="jisuan()">
										</td>
										<th style="background-color:#F5F5F6" width="25%">
											<span style="color:#000">其他费用：<span style="color:#9c9696">(特殊情况下使用)</span>
										</th>
										<td width="25%">
											<input type="text"  class="form-control input-sm" name="qita"  id="qita" onchange="jisuan()">
										</td>
