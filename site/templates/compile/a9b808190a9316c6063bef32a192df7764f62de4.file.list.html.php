<?php /* Smarty version Smarty-3.0.4, created on 2014-09-29 10:28:22
         compiled from "D:\Phpserv\qczn\site\templates\elsker\operator/finance/borrow/list.html" */ ?>
<?php /*%%SmartyHeaderCode:78005428c3c6ca86a6-02231175%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a9b808190a9316c6063bef32a192df7764f62de4' => 
    array (
      0 => 'D:\\Phpserv\\qczn\\site\\templates\\elsker\\operator/finance/borrow/list.html',
      1 => 1411957643,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '78005428c3c6ca86a6-02231175',
  'function' => 
  array (
  ),
...
">
	...
	<?php if ($_smarty_tpl->getVariable('op')->value!="check"){?>
	<td><?php if ((isset($_smarty_tpl->tpl_vars['row']->value['borrow_isAgree']) ? $_smarty_tpl->tpl_vars['row']->value['borrow_isAgree'] : null)==0){?>未审核<?php }else{ ?><?php if ((isset($_smarty_tpl->tpl_vars['row']->value['borrow_isAgree']) ? $_smarty_tpl->tpl_vars['row']->value['borrow_isAgree'] : null)==-1){?>审核未通过<?php }else{ ?>审核通过<?php }?><hr /><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['borrow_isAgreeMan']) ? $_smarty_tpl->tpl_vars['row']->value['borrow_isAgreeMan'] : null);?>
&nbsp;<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['borrow_isAgreeTime']) ? $_smarty_tpl->tpl_vars['row']->value['borrow_isAgreeTime'] : null);?>
<?php }?></td>
	<?php }?>
	<td><?php if ((isset($_smarty_tpl->tpl_vars['row']->value['borrow_isReturn']) ? $_smarty_tpl->tpl_vars['row']->value['borrow_isReturn'] : null)==0){?>未还款<?php }else{ ?>已还款<?php }?></td>
