<?php /* Smarty version Smarty-3.0.4, created on 2014-03-29 20:37:23
         compiled from "D:\Phpserv\elsker\admincp\site\templates\elsker\operator/message/list/list.html" */ ?>
<?php /*%%SmartyHeaderCode:108115336be831089b7-52563732%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '58584902f1cd4dae854c3bd62684954d889dc655' => 
    array (
      0 => 'D:\\Phpserv\\elsker\\admincp\\site\\templates\\elsker\\operator/message/list/list.html',
      1 => 1396096636,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '108115336be831089b7-52563732',
  'function' => 
  array (
  ),
...
?>
                <option value="<?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['message_cate_id']) ? $_smarty_tpl->tpl_vars['rows']->value['message_cate_id'] : null);?>
...
?>
  <tr overstyle='on' id="badge_<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['message_id']) ? $_smarty_tpl->tpl_vars['row']->value['message_id'] : null);?>
">
    	<td><input type="checkbox" name="checkbox" id="checkbox<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['message_id']) ? $_smarty_tpl->tpl_vars['row']->value['message_id'] : null);?>
" value="<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['message_id']) ? $_smarty_tpl->tpl_vars['row']->value['message_id'] : null);?>
"></td>
	  	<td ><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['message_id']) ? $_smarty_tpl->tpl_vars['row']->value['message_id'] : null);?>
</td>
    ...
    <!--    <td><?php if ((isset($_smarty_tpl->tpl_vars['row']->value['is_top']) ? $_smarty_tpl->tpl_vars['row']->value['is_top'] : null)==1){?><img src="/images/Sticky.png"><?php }?></td>        -->
	    <td>
			<a href="modify.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['message_id']) ? $_smarty_tpl->tpl_vars['row']->value['message_id'] : null);?>
">编辑</a> --            
            <a href="javascript:if(confirm('是否确定删除？')){window.location.href='delete.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['message_id']) ? $_smarty_tpl->tpl_vars['row']->value['message_id'] : null);?>
';}">删除</a>		
		</td>
 </tr>
 <?php }} ?>
