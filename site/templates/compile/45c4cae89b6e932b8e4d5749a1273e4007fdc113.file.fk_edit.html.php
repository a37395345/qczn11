<?php /* Smarty version Smarty-3.0.4, created on 2019-12-16 10:09:34
         compiled from "D:\WWW\qczn\site\templates\elsker\operator/beiyongjin/fk_edit.html" */ ?>
<?php /*%%SmartyHeaderCode:325815df6e75e7f5484-83628879%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '45c4cae89b6e932b8e4d5749a1273e4007fdc113' => 
    array (
      0 => 'D:\\WWW\\qczn\\site\\templates\\elsker\\operator/beiyongjin/fk_edit.html',
      1 => 1576459649,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '325815df6e75e7f5484-83628879',
  'function' => 
  array (
  ),
...
<div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="ibox float-e-margins">
		...
		<form method="post" action="index.php?task=fk_edit_action" name="form1" id="form1">
...
" id="pid" name="pid"> -->
								...
								<td width="35%">
									<input onkeyup="value=value.replace(/[^0-9\.]/g,'')" name="borrow_money" id="borrow_money" placeholder="必填" class="form-control input-sm" value="<?php echo (isset($_smarty_tpl->getVariable('data')->value['borrow_money']) ? $_smarty_tpl->getVariable('data')->value['borrow_money'] : null);?>
" >
								</td>
										<th style="background-color:#F5F5F6" width="15%">
										...
										<td width="35%">
				                              <input style="width: 78%;float: left;"type="text"class="form-control input-sm" id="borrow_remarks" name="borrow_remarks" value="<?php echo (isset($_smarty_tpl->getVariable('data')->value['borrow_remarks']) ? $_smarty_tpl->getVariable('data')->value['borrow_remarks'] : null);?>
" >
				                        </td>
									</tr>
									</table>
				...
				<input type="hidden" name="id" value="<?php echo (isset($_smarty_tpl->getVariable('data')->value['borrow_id']) ? $_smarty_tpl->getVariable('data')->value['borrow_id'] : null);?>
" id="id">
