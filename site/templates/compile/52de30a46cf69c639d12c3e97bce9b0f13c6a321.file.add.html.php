<?php /* Smarty version Smarty-3.0.4, created on 2019-09-29 18:55:52
         compiled from "/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/menu/add.html" */ ?>
<?php /*%%SmartyHeaderCode:18445862905d908db8ac07c1-67016873%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '52de30a46cf69c639d12c3e97bce9b0f13c6a321' => 
    array (
      0 => '/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/menu/add.html',
      1 => 1569749235,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18445862905d908db8ac07c1-67016873',
  'function' => 
  array (
  ),
...
">
                        ...
                        <tr>
                            <th style="background-color:#F5F5F6" width="15%">
                             ...
                             <td width="35%">
                               <input type="text" id="action" name="action"  class="form-control input-sm" placeholder="" >
                            </td>
                            ...
                            <td width="35%">
                               <input type="text" id="script" name="script"  class="form-control input-sm" placeholder="" >
                            </td>
                        </tr>
                        <tr>
                            <th style="background-color:#F5F5F6" width="15%">
                             ...
                             <td width="35%">
                                <input type="text" id="menu_order" name="menu_order"  class="form-control input-sm" placeholder="" >
