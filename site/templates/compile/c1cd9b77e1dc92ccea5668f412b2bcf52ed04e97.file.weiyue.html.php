<?php /* Smarty version Smarty-3.0.4, created on 2019-11-07 18:20:37
         compiled from "D:\WWW\qczn\site\templates\elsker\operator/changqi_zijia/weiyue.html" */ ?>
<?php /*%%SmartyHeaderCode:231175dc3eff524ef71-75686129%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c1cd9b77e1dc92ccea5668f412b2bcf52ed04e97' => 
    array (
      0 => 'D:\\WWW\\qczn\\site\\templates\\elsker\\operator/changqi_zijia/weiyue.html',
      1 => 1573122033,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '231175dc3eff524ef71-75686129',
  'function' => 
  array (
  ),
								...
								<div class="shiji">
									...
									<tr>
										<th style="background-color:#F5F5F6" width="15%">
											<span style="color:#000">违约方式：</span>
										</th>
										<td width="35%">
											<select class="form-control input-sm" id="weiyue_type" name="weiyue_type" >
		                                        <option value="1" <?php if ((isset($_smarty_tpl->getVariable('paiche')->value['weiyue_type']) ? $_smarty_tpl->getVariable('paiche')->value['weiyue_type'] : null)==1){?>selected<?php }?>>固定违约金</option>
		                                        <option value="2" <?php if ((isset($_smarty_tpl->getVariable('paiche')->value['weiyue_type']) ? $_smarty_tpl->getVariable('paiche')->value['weiyue_type'] : null)==2){?>selected<?php }?>>总租金的百分比</option> 
		                                        <option value="3" <?php if ((isset($_smarty_tpl->getVariable('paiche')->value['weiyue_type']) ? $_smarty_tpl->getVariable('paiche')->value['weiyue_type'] : null)==3){?>selected<?php }?>>剩余租金的百分比</option> 
		                                </select>
										</td>
										<th style="background-color:#F5F5F6" width="15%">
											<span style="color:#000" id="money"><?php if ((isset($_smarty_tpl->getVariable('paiche')->value['weiyue_type']) ? $_smarty_tpl->getVariable('paiche')->value['weiyue_type'] : null)==1){?>金额<?php }else{ ?>百分比<?php }?>：</span>
										</th>
										<td width="35%">
											<input type="text" onkeyup="value=value.replace(/[^\d.]/g,'')"  id="youhui" class="form-control input-sm"  value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['weiyue_money']) ? $_smarty_tpl->getVariable('paiche')->value['weiyue_money'] : null);?>
...
元">
									...
									<tr>
										...
										<td width="35%">
											<input type="number" min="0"  id="xuhao" name="xuhao" class="form-control input-sm" placeholder="8位数的发票号码" minlength="8" maxlength="8" >
										</td>
									</tr>
									</table>
								</div>
