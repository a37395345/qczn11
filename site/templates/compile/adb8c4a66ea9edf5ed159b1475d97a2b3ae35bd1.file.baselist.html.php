<?php /* Smarty version Smarty-3.0.4, created on 2014-07-29 11:26:48
         compiled from "D:\Phpserv\qczn\site\templates\elsker\operator/machine/baselist.html" */ ?>
<?php /*%%SmartyHeaderCode:342553d7147822cba2-76955885%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'adb8c4a66ea9edf5ed159b1475d97a2b3ae35bd1' => 
    array (
      0 => 'D:\\Phpserv\\qczn\\site\\templates\\elsker\\operator/machine/baselist.html',
      1 => 1406604392,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '342553d7147822cba2-76955885',
  'function' => 
  array (
  ),
    ...
    <div class="list">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
		    ...
		    <td><select name="car_position">
		    <option value="" >所有</option>
		    <option value="0" >无</option>
		    <option value="1" >有</option>
		    </select>
		    </td>
		    <td><select name="car_nav">
		    <option value="" >所有</option>
		    <option value="0" >无</option>
		    <option value="1" >有</option>
		    </select>
		    </td>
		    <td><select name="car_status">
		    <option value="" >所有</option>
...
"></td>	
		...
		<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['car_position']) ? $_smarty_tpl->tpl_vars['row']->value['car_position'] : null);?>
</td>
		<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['car_positionDate']) ? $_smarty_tpl->tpl_vars['row']->value['car_positionDate'] : null);?>
</td>
		<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['car_nav']) ? $_smarty_tpl->tpl_vars['row']->value['car_nav'] : null);?>
</td>
		<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['car_remarks']) ? $_smarty_tpl->tpl_vars['row']->value['car_remarks'] : null);?>
</td>
		<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['car_status']) ? $_smarty_tpl->tpl_vars['row']->value['car_status'] : null);?>
</td>
