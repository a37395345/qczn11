<?php /* Smarty version Smarty-3.0.4, created on 2019-10-17 13:19:43
         compiled from "/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/zijia_linshi/zijia_create.html" */ ?>
<?php /*%%SmartyHeaderCode:6007927585da7f9ef4caf99-17795759%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9d66ac9ff2e3aebd829a4a60d3cc5352208749d4' => 
    array (
      0 => '/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/zijia_linshi/zijia_create.html',
      1 => 1571289572,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6007927585da7f9ef4caf99-17795759',
  'function' => 
  array (
  ),
							...
							<div class="example">
								...
								<tr>
									...
									<div style="" id="ke_leixing">
										...
										<td width="35%">
											<input type="text" class="form-control input-sm" value="临时散客"   readonly="readonly" unselectable="on" id="pingtai_cc">
...
">
									...
									<tr id="paiche_bb">
										...
										<td width="35%">
											<input type="text" class="form-control input-sm" placeholder="必填" name="paiche_pintainum" id="paiche_pintainum" value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['paiche_pintainum']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_pintainum'] : null);?>
" >
										</td>
...
"  id="paicheServerMan" name="paicheServerMan">
						...
						<?php if ($_smarty_tpl->getVariable('paidan_type_a')->value=='diaoche'||$_smarty_tpl->getVariable('paidan_type_b')->value=="s"){?>
...
"><?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['paiche_contractNum']) ? $_smarty_tpl->tpl_vars['rows']->value['paiche_contractNum'] : null);?>
                             ...
                             <?php }?>
								...
								<tr>
									...
									<td width="35%">
										<input type="text" class="form-control input-sm  yuyue" placeholder="必填" name="paiche_linker" id="paiche_linker" <?php if ($_smarty_tpl->getVariable('paidan_type_a')->value=='update'||(isset($_smarty_tpl->getVariable('paiche')->value['paiche_pintaiid']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_pintaiid'] : null)){?>
...
" <?php }?>  >
									...
									<td width="35%">
										<input type="text" class="form-control input-sm" placeholder="必填" name="paiche_linkerPhone" id="paiche_linkerPhone" value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['paiche_linkerPhone']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_linkerPhone'] : null);?>
" >
									</td>
								</tr>
								...
								<tr class="f_changqi">
									...
									<td>
										<input type="text" class="form-control input-sm  yuyue" <?php if ($_smarty_tpl->getVariable('paidan_type_a')->value=='diaoche'||$_smarty_tpl->getVariable('paidan_type_b')->value=="s"){?>placeholder="必填" <?php }?> name="paiche_linkerNum" id="paiche_linkerNum" <?php if ($_smarty_tpl->getVariable('paidan_type_a')->value=='update'||(isset($_smarty_tpl->getVariable('paiche')->value['paiche_pintaiid']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_pintaiid'] : null)){?> value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['paiche_linkerNum']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_linkerNum'] : null);?>
" <?php }?>>
									</td>
									<th style="background-color:#F5F5F6">
									...
									<td>
										<input type="text" class="form-control input-sm  yuyue" placeholder="" name="paiche_linkerAdd" id="paiche_linkerAdd" <?php if ($_smarty_tpl->getVariable('paidan_type_a')->value=='update'||(isset($_smarty_tpl->getVariable('paiche')->value['paiche_pintaiid']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_pintaiid'] : null)){?> value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['paiche_linkerAdd']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_linkerAdd'] : null);?>
" <?php }?>>
									</td>
								</tr>
								</table>
...
" size="10"/>
									...
									<table class="table table-bordered" id="che" style="display: <?php if ((isset($_smarty_tpl->getVariable('paiche')->value['paicheCar2']) ? $_smarty_tpl->getVariable('paiche')->value['paicheCar2'] : null)>0||(isset($_smarty_tpl->getVariable('paiche')->value['paicheCar']) ? $_smarty_tpl->getVariable('paiche')->value['paicheCar'] : null)>0){?>table<?php }else{ ?>none<?php }?>">
									<tr>
										<th style="background-color:#F5F5F6" width="15%">
...
">
									...
									<td width="35%">
										<span style="display: block;width: 10%;float: left;line-height: 34px;text-align: right;">天:</span>
...
" onchange="jisuan_a()">
    ...
    height: 30px;" id="tjian" onclick="jisuan('t','g')">
										...
										<span style="display: block;width: 10%;float: left;line-height: 34px;text-align: right;">时：</span>
...
" onchange="jisuan_a()">
    ...
    height: 30px; " id="sjian" onclick="jisuan('s','g')">
										...
										<span style="display: block;width: 10%;float: left;line-height: 34px;text-align: right;">分：</span>
...
" class="laydate-icon"   unselectable="on" readonly>
									...
									<td width="35%">
										<label style="margin:0px;margin-right: 10px">
											...
											<input name="paiche_needtax" type="radio" value="1"/ 
											<?php if ((isset($_smarty_tpl->getVariable('paiche')->value['paiche_needtax']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_needtax'] : null)==1){?>checked<?php }?> style="display: block;float: left;margin: 3px;padding: 0"> 
											<span style="display: block;float: left;">开票</span> 
										</label>

										<label style="margin:0px;margin-right: 10px">
											<input name="paiche_needtax" type="radio" value="0"  
											<?php if ((isset($_smarty_tpl->getVariable('paiche')->value['paiche_needtax']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_needtax'] : null)!=1){?>checked<?php }?>/ style="display: block;float: left;margin: 3px;padding: 0">
											<span style="display: block;float: left;">不开票</span>
										</label>
									</td>
								...
								<tr>
									...
									<td width="35%">
										<input type="number" min="0" id="paiche_rent" name="paiche_rent" class="form-control input-sm " placeholder="" value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['paiche_rent']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_rent'] : null);?>
" onchange="jisuan_b()">
									</td>
									...
									<td width="35%">
										<input type="number" min="0"  id="paiche_deposit" name="paiche_deposit" class="form-control input-sm" placeholder=""  value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['paiche_deposit']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_deposit'] : null);?>
" onchange="jisuan_zujin()">
								...
								<tr>
									...
									<td width="35%">
										<input type="number" min="0" id="shuaka" name="shuaka" class="form-control input-sm " placeholder="" value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['shuaka']) ? $_smarty_tpl->getVariable('paiche')->value['shuaka'] : null);?>
" onchange="jisuan_zujin()">
									</td>
									...
									<td width="35%">
										<input type="number" min="0" id="qita" name="qita" class="form-control input-sm" placeholder=""  value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['qita']) ? $_smarty_tpl->getVariable('paiche')->value['qita'] : null);?>
" onchange="jisuan_zujin()">
									</td>
								</tr>
								...
								<tr>
									...
									<td width="35%">
										<input type="number" min="0" id="songche" name="songche" class="form-control input-sm" placeholder=""  value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['songche']) ? $_smarty_tpl->getVariable('paiche')->value['songche'] : null);?>
" onchange="jisuan_zujin()">
									</td>
									<th style="background-color:#F5F5F6" width="15%">
									...
									<td width="35%">
										<input type="text" id="suijin" name="suijin" class="form-control input-sm " placeholder="" value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['suijin']) ? $_smarty_tpl->getVariable('paiche')->value['suijin'] : null);?>
" readonly="readonly" unselectable="on">
									</td>
								</tr>
								<tr style="display: none" id="huodong">
									...
									<td width="35%">
										<select class="form-control input-sm" id="huodong_id"  name="huodong_id" value="">
...
">
									...
									<td width="35%">
										<input type="text" id="huodong_youhui" name="huodong_youhui"  class="form-control input-sm" placeholder=""  value="" readonly="readonly" unselectable="on">
									</td>
								</tr>
								<tr>
									<th style="background-color:#F5F5F6" width="15%">
									...
									<td width="35%">
										<input type="text" id="yishou"  class="form-control input-sm" placeholder=""  value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['yishou']) ? $_smarty_tpl->getVariable('paiche')->value['yishou'] : null);?>
" readonly="readonly" unselectable="on">
									</td>
									<th style="background-color:#F5F5F6" width="15%">
...
">
								...
								<tr>
									...
									<td width="35%">
										<input type="text" id="paiche_line" name="paiche_line" class="form-control input-sm" placeholder="必填"
