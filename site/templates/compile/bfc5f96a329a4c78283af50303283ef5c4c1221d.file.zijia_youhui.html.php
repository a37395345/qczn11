<?php /* Smarty version Smarty-3.0.4, created on 2019-10-17 14:07:06
         compiled from "/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/zijia_linshi/zijia_youhui.html" */ ?>
<?php /*%%SmartyHeaderCode:9988976725da8050a30bec8-48748341%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bfc5f96a329a4c78283af50303283ef5c4c1221d' => 
    array (
      0 => '/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/zijia_linshi/zijia_youhui.html',
      1 => 1571291810,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9988976725da8050a30bec8-48748341',
  'function' => 
  array (
  ),
...
" id="nengyouhui" name="nengyouhui">
								...
								<div class="shiji">
									...
									<tr>
										...
										<td width="35%">
											<input type="number" min="0"  id="youhui_mone" class="form-control input-sm" name="youhui_mone" placeholder="最多可以优惠<?php echo $_smarty_tpl->getVariable('nengyouhui')->value;?>
元">
										</td>
...
<script type="text/javascript">
	$('#submit').click(function(){
		...
		var youhui_mone=parseInt($("#youhui_mone").val());
		var nengyouhui=parseInt($("#nengyouhui").val());
