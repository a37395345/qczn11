<?php /* Smarty version Smarty-3.0.4, created on 2019-11-07 18:45:42
         compiled from "D:\WWW\qczn\site\templates\elsker\operator/changqi_zijia/qita.html" */ ?>
<?php /*%%SmartyHeaderCode:160755dc3f5d62ea213-89464127%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1b15faf745d2636512d50875f6392b3b6f319b45' => 
    array (
      0 => 'D:\\WWW\\qczn\\site\\templates\\elsker\\operator/changqi_zijia/qita.html',
      1 => 1573123537,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '160755dc3f5d62ea213-89464127',
  'function' => 
  array (
  ),
...
" id="paiche_needtax">
								<div class="shiji">
									...
									<tr>
										...
										<th style="background-color:#F5F5F6" width="25%">
											<span style="color:#000">违约金：</span>
										</th>
										<td width="25%">
											<input type="text" onkeyup="value=value.replace(/[^\d.]/g,'')"  class="form-control input-sm" name="weiyue" id="weiyue" placeholder="" onchange="jisuan()">
...
<script type="text/javascript">
	function jisuan(){
		...
		var weiyue=0;
		if(parseFloat($('#weiyue').val())>0){
			weiyue=parseFloat($('#weiyue').val());
		}
		var qingxi=0;
		...
		var num_money=qingxi+weixiu+shouche+yaoshi+qita+xingshi+weiyue;
		
		
		$('#yingshou').val(num_money);
