<?php /* Smarty version Smarty-3.0.4, created on 2019-12-24 10:43:32
         compiled from "D:\WWW\qczn\site\templates\elsker\operator/jinrongdiya/add.html" */ ?>
<?php /*%%SmartyHeaderCode:171455e017b54b08745-80276480%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b60b55fd646c1cf5845d3788304abdafb3508bc8' => 
    array (
      0 => 'D:\\WWW\\qczn\\site\\templates\\elsker\\operator/jinrongdiya/add.html',
      1 => 1577155410,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '171455e017b54b08745-80276480',
  'function' => 
  array (
  ),
				...
				<div class="row row-lg">
					<div class="col-sm-12">
								...
								<tr>
									...
									<td width="35%" style="text-align: center;">
										<select class="form-control input-sm" id="paiche_pintaiid" name="paiche_pintaiid" >
											<option  value="1" <?php if ((isset($_smarty_tpl->getVariable('paiche')->value['paiche_pintaiid']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_pintaiid'] : null)==0){?>selected<?php }?>>汽车抵押
											</option>

											<option  value="2" <?php if ((isset($_smarty_tpl->getVariable('paiche')->value['paiche_pintaiid']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_pintaiid'] : null)!=0){?>selected<?php }?>>黄金首饰抵押
											</option>
										</select>
									</td>
						...
						<div style="clear: both;">
										...
										<tr>
											<th style="background-color:#F5F5F6" width="15%">
												<span style="color:#000">抵押人姓名</span>
											</th>
											<td width="35%" style="text-align: center;">
											...
											<th style="background-color:#F5F5F6" width="15%">
												<span style="color:#000">抵押人身份证号码</span>
											</th>
											<td width="35%">
										...
										<tr>
											<th style="background-color:#F5F5F6" width="15%">
												<span style="color:#000">抵押人照片</span>
											</th>
											<td width="35%">
...
">
								...
								<tr>
									...
									<th style="background-color:#F5F5F6" width="15%">
										<span style="color:#000">抵押人电话号码</span>
									</th>
									<td width="35%">
					...
					<input type="text" class="form-control input-sm"  name="paiche_linkerNum" id="paiche_linkerNum" readonly="readonly" unselectable="on">
								...
								<div id="xixi">
									...
									<tr>
										...
										<td width="35%">
											<input type="text" id="car_num" class="form-control input-sm" placeholder="必填"  >
										</td>
										<th style="background-color:#F5F5F6" width="15%">
											<span style="color:#000">车辆颜色</span>
										</th>
										<td width="35%">
											<input type="text" id="car_color" class="form-control input-sm" placeholder="必填" >
										</td>
									</tr>
									<tr>
										...
										<td width="35%">
											<input type="text" id="car_types_a" class="form-control input-sm" placeholder="必填"  >
...
">
										...
										<th style="background-color:#F5F5F6" width="15%">
											<span style="color:#000">行驶公里</span>
										</th>
										<td width="35%">
											<input type="text" id="car_amount" class="form-control input-sm" placeholder="必填" value="">
										</td>
									</tr>
...
">
									...
									<tr>
										...
										<th style="background-color:#F5F5F6" width="15%">
											<span style="color:#000">首次上牌</span>
										</th>
										<td width="35%">
											<input type="text" id="car_types_a" class="form-control input-sm" placeholder="必填"  >
...
">
									...
									<th style="background-color:#F5F5F6" width="15%">
										<span style="color:#000">发放金额</span>
									</th>
									<td width="35%">
								...
								<tr>
									...
									<th style="background-color:#F5F5F6" width="15%">
										<span style="color:#000">到期回款金额</span>
									</th>
									<td width="35%">
								...
								<tr>
									<th style="background-color:#F5F5F6" width="15%">
										<span style="color:#000">存放位置</span>
									</th>
									<td width="35%">
										<select class="form-control input-sm" id="paiche_cun" name="paiche_cun">
											<option  value="0" selected>请选择
											</option>
											<option  value="1" selected>蒋政处
											</option>
											<option  value="2" selected>何艳阳处
											</option>
											<option  value="3" selected>武进店保险箱
											</option>
											<option  value="4" selected>车库
											</option>
										</select>
...
<script type="text/javascript" src="../../../js/jinrongdiya.js?a=<?php echo time();?>
"></script>
</body>
