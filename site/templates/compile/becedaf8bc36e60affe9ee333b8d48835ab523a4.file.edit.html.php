<?php /* Smarty version Smarty-3.0.4, created on 2019-09-30 09:25:00
         compiled from "/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/emp/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:15112988535d91596cbc63c6-97337284%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'becedaf8bc36e60affe9ee333b8d48835ab523a4' => 
    array (
      0 => '/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/emp/edit.html',
      1 => 1569749212,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15112988535d91596cbc63c6-97337284',
  'function' => 
  array (
  ),
...
">
                        ...
                        <tr>
                            ...
                            <td width="35%">
                               <input type="text" id="jinji_name" name="jinji_name"  class="form-control input-sm" placeholder="必填"  value="<?php echo (isset($_smarty_tpl->getVariable('data')->value['jinji_name']) ? $_smarty_tpl->getVariable('data')->value['jinji_name'] : null);?>
">
                            </td>
                            <th style="background-color:#F5F5F6" width="15%">
...
">
                        ...
                        <tr>
                            <th style="background-color:#F5F5F6" width="15%">
                             ...
                             <td width="35%">
                                <input type="text" id="emp_kahao" name="emp_kahao"  class="form-control input-sm" placeholder="" minlength="16" maxlength="19" value="<?php echo (isset($_smarty_tpl->getVariable('data')->value['emp_kahao']) ? $_smarty_tpl->getVariable('data')->value['emp_kahao'] : null);?>
">
                            </td>
                             <th style="background-color:#F5F5F6" width="15%">
