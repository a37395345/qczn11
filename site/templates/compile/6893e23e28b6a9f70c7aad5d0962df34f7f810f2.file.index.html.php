<?php /* Smarty version Smarty-3.0.4, created on 2020-01-06 17:01:53
         compiled from "D:\WWW\qczn\site\templates\elsker\operator/gpskaizou/index.html" */ ?>
<?php /*%%SmartyHeaderCode:281615e12f7812a7de0-53592736%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6893e23e28b6a9f70c7aad5d0962df34f7f810f2' => 
    array (
      0 => 'D:\\WWW\\qczn\\site\\templates\\elsker\\operator/gpskaizou/index.html',
      1 => 1578117897,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '281615e12f7812a7de0-53592736',
  'function' => 
  array (
  ),
...
?>
                ...
                <?php }?>;">
                    <?php echo (isset($_smarty_tpl->tpl_vars['row']->value['zhuangtai']) ? $_smarty_tpl->tpl_vars['row']->value['zhuangtai'] : null);?>
	        								...
	        								<td style="text-align: center;"><span style="border-bottom:1px solid #b19d9d;line-height: 23px"><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_linker']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_linker'] : null);?>
(<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_linkerPhone']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_linkerPhone'] : null);?>
)</span>
	        								<br/>
	        								<span style="border-bottom:1px solid #b19d9d;line-height: 23px"><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_linkerNum']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_linkerNum'] : null);?>
</span>
	        								<br/>
	        								<span style="border-bottom:1px solid #b19d9d;line-height: 23px"><p class="sf_type"><?php if ((isset($_smarty_tpl->tpl_vars['row']->value['paiche_stype']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_stype'] : null)==1){?>刷身份证验证<?php }elseif((isset($_smarty_tpl->tpl_vars['row']->value['paiche_stype']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_stype'] : null)==3){?>人脸识别<?php }else{ ?>异常<?php }?></p></span>
	        								</td>
...
);return false" title="结账" style="color:#CC6600">
...
" class="pid">
 ...
 项
	...
	<input type="hidden" id="paiche_stype">
	...
	<script>
	    ...
	    function edit(pid){
	    	setBody_W();
	        demo_iframe('index.php?task=edit&pid='+pid,'修改业务',body_W,500,'login_js');  
        }
        function discount(pid){
        	setBody_W();
	        demo_iframe('index.php?task=discount&pid='+pid,'添加优惠',body_W,500,'login_js');
	    }
	    function huanche(pid){
	    	setBody_W();
	        demo_iframe('index.php?task=huanche&pid='+pid,'结账',body_W,500,'login_js');
	    }
	    function qitamoney(pid){
	    	setBody_W();
	        demo_iframe('index.php?task=qitamoney&pid='+pid,'增加其他费用',body_W,500,'login_js');
	    }
