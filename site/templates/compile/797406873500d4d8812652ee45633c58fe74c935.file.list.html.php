<?php /* Smarty version Smarty-3.0.4, created on 2018-10-21 12:30:56
         compiled from "D:\web\site\templates\elsker\operator/business/list.html" */ ?>
<?php /*%%SmartyHeaderCode:272515bcc01008d1f59-53795149%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '797406873500d4d8812652ee45633c58fe74c935' => 
    array (
      0 => 'D:\\web\\site\\templates\\elsker\\operator/business/list.html',
      1 => 1540096087,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '272515bcc01008d1f59-53795149',
  'function' => 
  array (
  ),
...
负责
    <?php }} ?></br>
    <input type="radio" name="showtype" value="d" <?php if ($_smarty_tpl->getVariable('search_status')->value=="d"){?>checked<?php }?>>已调度未还车<input type="radio" name="showtype" value="y" <?php if ($_smarty_tpl->getVariable('search_status')->value=="y"){?>checked<?php }?>>预约
    <?php if ($_smarty_tpl->getVariable('busitype')->value=="2"){?><input type="radio" name="showtype" value="r1" <?php if ($_smarty_tpl->getVariable('search_status')->value=="r1"){?>checked<?php }?>>已还车(现结)<input type="radio" name="showtype" value="r2" <?php if ($_smarty_tpl->getVariable('search_status')->value=="r2"){?>checked<?php }?>>已还车(批结)
    <?php }else{ ?><input type="radio" name="showtype" value="r" <?php if ($_smarty_tpl->getVariable('search_status')->value=="r"){?>checked<?php }?>>已还车<?php }?>
...
" target="blank">明细</a>
	    ...
	    <?php if ($_smarty_tpl->getVariable('canreturn')->value==1){?><a href="javascript:returnCar(<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_id']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_id'] : null);?>
);">还车</a><?php }else{ ?>还车<?php }?>
...
">编辑</a>&nbsp;<a href="javascript:if(confirm('是否确定删除该派车单？')){window.location.href='cancel.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_id']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_id'] : null);?>
&b_id=<?php echo $_smarty_tpl->getVariable('busitype')->value;?>
';}">删除</a><?php }?>
...
&className=outCar" target="_blank">打印出车单</a>
            ...
            <?php }?>
            <?php if (($_smarty_tpl->getVariable('busitype')->value=='1'||$_smarty_tpl->getVariable('busitype')->value=='2')&&(isset($_smarty_tpl->tpl_vars['row']->value['settle_totalKm']) ? $_smarty_tpl->tpl_vars['row']->value['settle_totalKm'] : null)!=0&&strstr($_smarty_tpl->getVariable('a_permissions')->value,'modifyorder')){?> <a href="javascript:cancelreturncar(<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_id']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_id'] : null);?>
);">撤销还车</a><?php }?>
            <?php if (($_smarty_tpl->getVariable('nowshopid')->value==(isset($_smarty_tpl->tpl_vars['row']->value['paiche_shopid']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_shopid'] : null)||$_smarty_tpl->getVariable('nowshopid')->value==(isset($_smarty_tpl->tpl_vars['row']->value['paicheCounterShop']) ? $_smarty_tpl->tpl_vars['row']->value['paicheCounterShop'] : null))||strstr($_smarty_tpl->getVariable('a_permissions')->value,'searchorder')){?><a href="detail.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_id']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_id'] : null);?>
" target="blank">明细</a><?php }else{ ?>明细<?php }?>
        <?php }?>
		</td>
 </tr>
