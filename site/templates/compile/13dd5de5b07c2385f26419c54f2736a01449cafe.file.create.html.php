<?php /* Smarty version Smarty-3.0.4, created on 2014-08-21 11:14:13
         compiled from "D:\Phpserv\qczn\site\templates\elsker\operator/insur/create.html" */ ?>
<?php /*%%SmartyHeaderCode:1215553f56405becae5-21688440%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '13dd5de5b07c2385f26419c54f2736a01449cafe' => 
    array (
      0 => 'D:\\Phpserv\\qczn\\site\\templates\\elsker\\operator/insur/create.html',
      1 => 1408590847,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1215553f56405becae5-21688440',
  'function' => 
  array (
  ),
...
" onclick="calendar.show(this);" readonly="readonly" /></dd>
	  ...
	  <dl class="lineD">
	    <dt><span class="redstar">*</span>保费：</dt>
	    <dd><input type="text" name="insurance_money" size="10" value="<?php echo (isset($_smarty_tpl->getVariable('list')->value['insurance_money']) ? $_smarty_tpl->getVariable('list')->value['insurance_money'] : null);?>
"/>元</dd>
	  </dl>
	  <dl class="lineD">
	    <dt>投保险种：</dt>
	    ...
	    <input type="checkbox" name="insurance_item[]" size="16" value="三责险" <?php if (strstr((isset($_smarty_tpl->getVariable('list')->value['insurance_item']) ? $_smarty_tpl->getVariable('list')->value['insurance_item'] : null),"三责险")){?>checked<?php }?>/>三责险
	    ...
	    <input type="checkbox" name="insurance_item[]" size="16" value="破碎险" <?php if (strstr((isset($_smarty_tpl->getVariable('list')->value['insurance_item']) ? $_smarty_tpl->getVariable('list')->value['insurance_item'] : null),"破碎险")){?>checked<?php }?>/>破碎险
	    </dd>
	  </dl>
	  <dl class="lineD">
	    <dt>备注：</dt>
