<?php /* Smarty version Smarty-3.0.4, created on 2014-09-05 11:16:51
         compiled from "D:\Phpserv\qczn\site\templates\elsker\operator/sales/negotiate/list.html" */ ?>
<?php /*%%SmartyHeaderCode:1919354092b2307abe2-89736745%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '314aa97134ae6a921ac6225ba2d4584be27aa07a' => 
    array (
      0 => 'D:\\Phpserv\\qczn\\site\\templates\\elsker\\operator/sales/negotiate/list.html',
      1 => 1409886933,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1919354092b2307abe2-89736745',
  'function' => 
  array (
  ),
...
<hr /><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['consult_endDate']) ? $_smarty_tpl->tpl_vars['row']->value['consult_endDate'] : null);?>
</td>
...
?>
	    <tr>
			...
			<td>
			<a href="modify.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row1']->value['negotiate_id']) ? $_smarty_tpl->tpl_vars['row1']->value['negotiate_id'] : null);?>
">编辑</a>&nbsp;
			<a href="javascript:if(confirm('是否确定删除该记录？')){window.location.href='delete.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row1']->value['negotiate_id']) ? $_smarty_tpl->tpl_vars['row1']->value['negotiate_id'] : null);?>
';}">删除</a>
			</td>
 		</tr>
	    <?php }} ?>
...
条记录&nbsp;&nbsp;&nbsp;<?php echo $_smarty_tpl->getVariable('PAGINATION')->value;?>
	...
	<?php if ($_smarty_tpl->getVariable('op')->value!="negotiate"){?><a href="create.php?item=<?php echo $_smarty_tpl->getVariable('item')->value;?>
...
<script>
    ...
    function negotiate(uid){
    	demo_iframe('create.php?uid='+uid,'洽谈结果反馈',650,460,'login_js');
    }
