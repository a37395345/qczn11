<?php /* Smarty version Smarty-3.0.4, created on 2015-09-12 16:55:08
         compiled from "D:\czyhqc\site\templates\elsker\operator/busiaccount/list.html" */ ?>
<?php /*%%SmartyHeaderCode:2358855f3e86c7c9f75-51534991%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '642235c9270fdc95a026be1d628f1add4320dc0d' => 
    array (
      0 => 'D:\\czyhqc\\site\\templates\\elsker\\operator/busiaccount/list.html',
      1 => 1442043625,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2358855f3e86c7c9f75-51534991',
  'function' => 
  array (
  ),
...
条记录&nbsp;&nbsp;&nbsp;<?php echo $_smarty_tpl->getVariable('PAGINATION')->value;?>
	...
	<?php if ($_smarty_tpl->getVariable('op')->value=="account0"||$_smarty_tpl->getVariable('op')->value=="account1"){?><input type="radio" value="0" name="busi_id" <?php if ($_smarty_tpl->getVariable('b_id')->value==0){?>checked<?php }?>/>全部<input type="radio" value="1" name="busi_id" <?php if ($_smarty_tpl->getVariable('b_id')->value==1){?>checked<?php }?>/>自驾 <input type="radio" value="2" name="busi_id" <?php if ($_smarty_tpl->getVariable('b_id')->value==2){?>checked<?php }?>/>代驾<?php }?>
  </div>
  <div class="list">
