<?php /* Smarty version Smarty-3.0.4, created on 2015-09-26 15:22:44
         compiled from "D:\czyhqc\site\templates\elsker\operator/busilong/paichelist.html" */ ?>
<?php /*%%SmartyHeaderCode:5670560647c4cc25f4-26797659%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '946c66c18a2972dfe5b2d562eb77f42308a1be74' => 
    array (
      0 => 'D:\\czyhqc\\site\\templates\\elsker\\operator/busilong/paichelist.html',
      1 => 1443252134,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5670560647c4cc25f4-26797659',
  'function' => 
  array (
  ),
...
条记录</div>
	<a href="../business/create.php?parentid=<?php echo (isset($_smarty_tpl->getVariable('info')->value['contract_id']) ? $_smarty_tpl->getVariable('info')->value['contract_id'] : null);?>
" class="btn_a">新建派车单</a>
...
<?php }?></td>
		...
		<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_startDate2']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_startDate2'] : null);?>
<hr /><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_endDate2']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_endDate2'] : null);?>
</td>
...
);">还车</a><?php }else{ ?><a href="../business/outcar.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_id']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_id'] : null);?>
">出车单</a>&nbsp;|&nbsp;
	    <a href="../business/list.php?task=outcarlist&pid=<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['paiche_id']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_id'] : null);?>
">月结</a><?php }?>
	    &nbsp;|&nbsp;
	    <?php }?>
...
<script>
	...
	function giveCar(pid){
		demo_iframe('../business/givecar.php?pid='+pid,'代驾交车',750,460,'login_js');
	}
	function vio(pid){
