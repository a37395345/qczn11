<?php /* Smarty version Smarty-3.0.4, created on 2014-05-06 22:00:33
         compiled from "D:\Phpserv\elsker\admincp\site\templates\elsker\operator/survey/list/list.html" */ ?>
<?php /*%%SmartyHeaderCode:92055368eb01949639-16911770%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5a9dbdc372d9f96daf8f8d24685a2c4dd2eca4ee' => 
    array (
      0 => 'D:\\Phpserv\\elsker\\admincp\\site\\templates\\elsker\\operator/survey/list/list.html',
      1 => 1399384824,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '92055368eb01949639-16911770',
  'function' => 
  array (
  ),
...
?>
                <option value="<?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['look_book_cate_id']) ? $_smarty_tpl->tpl_vars['rows']->value['look_book_cate_id'] : null);?>
...
"></td>
        ...
        <td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['intro']) ? $_smarty_tpl->tpl_vars['row']->value['intro'] : null);?>
</td>
...
';}">删除</a>
            <a href="../add/list.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['id']) ? $_smarty_tpl->tpl_vars['row']->value['id'] : null);?>
">管理问卷内容</a>
            <a href="../result/list.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['id']) ? $_smarty_tpl->tpl_vars['row']->value['id'] : null);?>
">查看调查结果</a>
        </td>
 </tr>
 <?php }} ?>
