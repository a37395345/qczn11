<?php /* Smarty version Smarty-3.0.4, created on 2019-09-18 03:49:56
         compiled from "F:\WWW\qczn\site\templates\elsker\operator/zijia_linshi/zijia_create.html" */ ?>
<?php /*%%SmartyHeaderCode:152555d8138e45c6cd5-32579138%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '152555d8138e45c6cd5-32579138',
  'function' => 
  array (
  ),
...
" class="laydate-icon"   unselectable="on" readonly>
								...
								<tr>
									...
									<td width="35%">
										<input type="text" id="paiche_rent" name="paiche_rent" class="form-control input-sm " placeholder="" value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['paiche_rent']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_rent'] : null);?>
" onchange="jisuan_b()">
									</td>
									...
									<td width="35%">
										<input type="text"  id="paiche_deposit" name="paiche_deposit" class="form-control input-sm" placeholder=""  value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['paiche_deposit']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_deposit'] : null);?>
" onchange="jisuan_zujin()">
								...
								<tr>
									...
									<td width="35%">
										<input type="text" id="shuaka" name="shuaka" class="form-control input-sm " placeholder="" value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['shuaka']) ? $_smarty_tpl->getVariable('paiche')->value['shuaka'] : null);?>
" onchange="jisuan_zujin()">
									</td>
									...
									<td width="35%">
										<input type="text" id="qita" name="qita" class="form-control input-sm" placeholder=""  value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['qita']) ? $_smarty_tpl->getVariable('paiche')->value['qita'] : null);?>
" onchange="jisuan_zujin()">
									</td>
								</tr>
								...
								<tr>
									...
									<td width="35%">
										<input type="text" id="songche" name="songche" class="form-control input-sm" placeholder=""  value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['songche']) ? $_smarty_tpl->getVariable('paiche')->value['songche'] : null);?>
" onchange="jisuan_zujin()">
									</td>
									<th style="background-color:#F5F5F6" width="15%">
