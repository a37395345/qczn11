<?php /* Smarty version Smarty-3.0.4, created on 2014-08-01 13:39:21
         compiled from "D:\Phpserv\qczn\site\templates\elsker\operator/base/create.html" */ ?>
<?php /*%%SmartyHeaderCode:661053db280966b688-24296391%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a3b85e53b607b61e446758508aa2d94bdec2db6f' => 
    array (
      0 => 'D:\\Phpserv\\qczn\\site\\templates\\elsker\\operator/base/create.html',
      1 => 1406871550,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '661053db280966b688-24296391',
  'function' => 
  array (
  ),
...
" /><input type="button" class="sub" value="增加其他联系人" onClick="addlinker()" /></dd>
	  </dl>
	  <dl class="lineD">
...
"/></dd>
	  ...
	  <div style='margin-top:5px'>
	  	<ul>
		<li>姓名：<input type="text" name="client_linker" id="client_linker" size="45"  value="<?php echo (isset($_smarty_tpl->getVariable('list')->value['client_linker']) ? $_smarty_tpl->getVariable('list')->value['client_linker'] : null);?>
" readonly="readonly" /></li>
		</ul>
		<ul>
		<li>手机：<input type="text" name="client_phone" id="client_phone" size="90"  value="<?php echo (isset($_smarty_tpl->getVariable('list')->value['client_phone']) ? $_smarty_tpl->getVariable('list')->value['client_phone'] : null);?>
" readonly="readonly" /></li>
		</ul>
		<ul>
		<li>职务：<input type="text" name="client_post" id="client_post" size="45"  value="<?php echo (isset($_smarty_tpl->getVariable('list')->value['client_post']) ? $_smarty_tpl->getVariable('list')->value['client_post'] : null);?>
" readonly="readonly" /></li>
		</ul>
		<ul>
		<li>备注：<input type="text" name="client_remark" id="client_remark" size="100"  value="<?php echo (isset($_smarty_tpl->getVariable('list')->value['client_remark']) ? $_smarty_tpl->getVariable('list')->value['client_remark'] : null);?>
" readonly="readonly" /></li>
		</ul>	  
	  </div>
	  </dd>
