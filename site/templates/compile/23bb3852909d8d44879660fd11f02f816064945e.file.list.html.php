<?php /* Smarty version Smarty-3.0.4, created on 2014-08-21 16:51:36
         compiled from "D:\Phpserv\qczn\site\templates\elsker\operator/insur/list.html" */ ?>
<?php /*%%SmartyHeaderCode:2281553f5b31844a375-60385303%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '23bb3852909d8d44879660fd11f02f816064945e' => 
    array (
      0 => 'D:\\Phpserv\\qczn\\site\\templates\\elsker\\operator/insur/list.html',
      1 => 1408611084,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2281553f5b31844a375-60385303',
  'function' => 
  array (
  ),
...
条记录&nbsp;&nbsp;&nbsp;<?php echo $_smarty_tpl->getVariable('PAGINATION')->value;?>
  ...
  <tr>
    ...
    <th>车辆购买日期</th>
    <th>保险到期日期</th>
    <th style="text-align:left;" width="58%">保险购买记录</th>
  </tr>
...
"></td>	
		...
		<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['car_insuranceDate']) ? $_smarty_tpl->tpl_vars['row']->value['car_insuranceDate'] : null);?>
</td>
...
?>
	    <tr>
		    <td><?php echo (isset($_smarty_tpl->tpl_vars['row1']->value['insurance_start']) ? $_smarty_tpl->tpl_vars['row1']->value['insurance_start'] : null);?>
</td>
			<td><?php echo (isset($_smarty_tpl->tpl_vars['row1']->value['insurance_end']) ? $_smarty_tpl->tpl_vars['row1']->value['insurance_end'] : null);?>
</td>
			<td><?php echo (isset($_smarty_tpl->tpl_vars['row1']->value['insurance_money']) ? $_smarty_tpl->tpl_vars['row1']->value['insurance_money'] : null);?>
</td>
			<td><?php echo (isset($_smarty_tpl->tpl_vars['row1']->value['insurance_item']) ? $_smarty_tpl->tpl_vars['row1']->value['insurance_item'] : null);?>
</td>
			<td><?php echo (isset($_smarty_tpl->tpl_vars['row1']->value['insurance_remark']) ? $_smarty_tpl->tpl_vars['row1']->value['insurance_remark'] : null);?>
</td>
			<td><a href="modify.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row1']->value['insurance_id']) ? $_smarty_tpl->tpl_vars['row1']->value['insurance_id'] : null);?>
">编辑</a>&nbsp;<a href="javascript:if(confirm('是否确定删除该车险记录？')){window.location.href='delete.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row1']->value['insurance_id']) ? $_smarty_tpl->tpl_vars['row1']->value['insurance_id'] : null);?>
';}">删除</a>
 		</tr>
	    <?php }} ?>
	    </table>
