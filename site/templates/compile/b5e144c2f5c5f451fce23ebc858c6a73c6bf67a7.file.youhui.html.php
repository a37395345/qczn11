<?php /* Smarty version Smarty-3.0.4, created on 2019-12-30 14:10:07
         compiled from "D:\WWW\qczn\site\templates\elsker\operator/gpskaizou/youhui.html" */ ?>
<?php /*%%SmartyHeaderCode:31635e0994bfb1dc25-74262851%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b5e144c2f5c5f451fce23ebc858c6a73c6bf67a7' => 
    array (
      0 => 'D:\\WWW\\qczn\\site\\templates\\elsker\\operator/gpskaizou/youhui.html',
      1 => 1577514038,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '31635e0994bfb1dc25-74262851',
  'function' => 
  array (
  ),
...
<div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="ibox float-e-margins">
		...
		<form method="post" action="index.php?task=deal_discount" name="form1" id="form1">
...
" id="nengyouhui" name="nengyouhui">
								...
								<div class="shiji">
									...
									<tr>
										...
										<td width="35%">
											<input type="text" onkeyup="value=value.replace(/[^\d.]/g,'')"  id="youhui_money" class="form-control input-sm" name="youhui_money" placeholder="最多可以优惠<?php echo $_smarty_tpl->getVariable('nengyouhui')->value;?>
元">
										</td>
...
<script type="text/javascript">
	$('#submit').click(function(){
		...
		var youhui_money=parseFloat($("#youhui_money").val());
