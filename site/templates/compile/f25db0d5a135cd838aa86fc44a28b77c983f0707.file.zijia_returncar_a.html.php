<?php /* Smarty version Smarty-3.0.4, created on 2020-03-03 15:30:13
         compiled from "D:\WWW\qczn\site\templates\elsker\operator/zijia_linshi/zijia_returncar_a.html" */ ?>
<?php /*%%SmartyHeaderCode:57915e5e0785cea8e3-61059228%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f25db0d5a135cd838aa86fc44a28b77c983f0707' => 
    array (
      0 => 'D:\\WWW\\qczn\\site\\templates\\elsker\\operator/zijia_linshi/zijia_returncar_a.html',
      1 => 1579225817,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '57915e5e0785cea8e3-61059228',
  'function' => 
  array (
  ),
...
<script type="text/javascript">
	...
	function jisuan(){
		...
		if(parseFloat($('#chaoshi_feiyong').val())>0){
			chaoshi_feiyong=parseInt($('#chaoshi_feiyong').val());
		}	
		//还需要收取的费用

		var haixu_a=0;
		if(parseFloat($('#haixu_a').val())>0){
			haixu_a=parseFloat($('#haixu_a').val());
		}
		...
		if(plan_chaokm=='y'){
			...
			//超公里费用
			var plan_chaokmy=0;
			if(parseFloat($('#plan_chaokmy').val())>0){
				plan_chaokmy=parseFloat($('#plan_chaokmy').val());
			}
