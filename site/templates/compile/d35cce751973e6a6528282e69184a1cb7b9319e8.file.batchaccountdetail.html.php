<?php /* Smarty version Smarty-3.0.4, created on 2019-10-07 14:51:18
         compiled from "/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/business/batchaccountdetail.html" */ ?>
<?php /*%%SmartyHeaderCode:16605691715d9ae0665b7c12-27042834%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd35cce751973e6a6528282e69184a1cb7b9319e8' => 
    array (
      0 => '/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/business/batchaccountdetail.html',
      1 => 1569749207,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16605691715d9ae0665b7c12-27042834',
  'function' => 
  array (
  ),
...
元-已结算:<?php echo (isset($_smarty_tpl->tpl_vars['row2']->value['have_in_money']) ? $_smarty_tpl->tpl_vars['row2']->value['have_in_money'] : null);?>
...
-已结算:<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['settle_overKmMoney_have']) ? $_smarty_tpl->tpl_vars['row']->value['settle_overKmMoney_have'] : null);?>
<?php }?>
...
-已结算:<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['settle_overTimeMoney_have']) ? $_smarty_tpl->tpl_vars['row']->value['settle_overTimeMoney_have'] : null);?>
<?php }?>
        <?php if ((isset($_smarty_tpl->tpl_vars['row']->value['settle_waitTimeMoney']) ? $_smarty_tpl->tpl_vars['row']->value['settle_waitTimeMoney'] : null)!=0){?><?php $_smarty_tpl->tpl_vars['summoney'] = new Smarty_variable($_smarty_tpl->getVariable('summoney')->value+(isset($_smarty_tpl->tpl_vars['row']->value['settle_waitTimeMoney']) ? $_smarty_tpl->tpl_vars['row']->value['settle_waitTimeMoney'] : null), null, null);?><hr />等待费:<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['settle_waitTimeMoney']) ? $_smarty_tpl->tpl_vars['row']->value['settle_waitTimeMoney'] : null);?>
-已结算:<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['settle_waitTimeMoney_have']) ? $_smarty_tpl->tpl_vars['row']->value['settle_waitTimeMoney_have'] : null);?>
<?php }?>
...
元</td>
 ...
 <?php }?>
 <?php if ($_smarty_tpl->getVariable('favorreason')->value!=''){?>
 <tr bgcolor="#fffeab">
 	<td>优惠原因</td>
 	<td colspan="9" style="text-align:left;"><?php echo $_smarty_tpl->getVariable('favorreason')->value;?>
</td>
 </tr>
 <?php }?>
 </table>
