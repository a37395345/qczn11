<?php /* Smarty version Smarty-3.0.4, created on 2020-03-07 17:21:20
         compiled from "D:\WWW\qczn\site\templates\elsker\operator/daijia_linshi/print_b.html" */ ?>
<?php /*%%SmartyHeaderCode:279105e6367903550c9-99352897%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b0d872997e972071deb6090c23b4df594097cc02' => 
    array (
      0 => 'D:\\WWW\\qczn\\site\\templates\\elsker\\operator/daijia_linshi/print_b.html',
      1 => 1583572878,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '279105e6367903550c9-99352897',
  'function' => 
  array (
  ),
...
<table border="1" cellspacing="0" cellpadding="0" width="100%" class="table" style="text-align:center;border:#c4c4c4 solid 1px;line-height:0px;font-size: 15px;">
  ...
  <tr>
    ...
    <td width="25%">电话</td>
    <td width="25%">（大客户部文员/调度）</td>
    
  </tr>
  <tr>
    <td>乙方</td>
    <td colspan="3"><p> <?php echo (isset($_smarty_tpl->getVariable('paiche')->value['client_name']) ? $_smarty_tpl->getVariable('paiche')->value['client_name'] : null);?>
</p></td>
  </tr>
  <tr>

    <td>联系人</td>
    <td><?php echo (isset($_smarty_tpl->getVariable('paiche')->value['name']) ? $_smarty_tpl->getVariable('paiche')->value['name'] : null);?>
</td>
    <td>电话</td>
    <td><?php echo (isset($_smarty_tpl->getVariable('paiche')->value['phone']) ? $_smarty_tpl->getVariable('paiche')->value['phone'] : null);?>
</td>
