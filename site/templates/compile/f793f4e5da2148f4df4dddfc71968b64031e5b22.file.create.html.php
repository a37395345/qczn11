<?php /* Smarty version Smarty-3.0.4, created on 2019-12-06 15:26:45
         compiled from "D:\WWW\qczn\site\templates\elsker\operator/machine/create.html" */ ?>
<?php /*%%SmartyHeaderCode:149935dea02b54f64f8-66432296%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f793f4e5da2148f4df4dddfc71968b64031e5b22' => 
    array (
      0 => 'D:\\WWW\\qczn\\site\\templates\\elsker\\operator/machine/create.html',
      1 => 1575617195,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '149935dea02b54f64f8-66432296',
  'function' => 
  array (
  ),
...
" onclick="calendar.show(this);" /></dd>
	  ...
	  <dl class="lineD">
	    <dt><span class="redstar">*</span>保险备注：</dt>
	    <dd><textarea name="car_remarks_a" cols="40" rows="5"><?php echo (isset($_smarty_tpl->getVariable('list')->value['car_remarks_a']) ? $_smarty_tpl->getVariable('list')->value['car_remarks_a'] : null);?>
</textarea></dd>
	  </dl>
	  <dl class="lineD">
	    <dt>车辆备注：</dt>
	  ...
	  <dl class="lineD">
	    <dt>注意事项：</dt>
	    <dd><textarea name="car_remarks_b" cols="40" rows="5"><?php echo (isset($_smarty_tpl->getVariable('list')->value['car_remarks_b']) ? $_smarty_tpl->getVariable('list')->value['car_remarks_b'] : null);?>
</textarea></dd>
	  </dl>

	  <dl class="lineD">
	    <dt>车辆属性：</dt>
	    <dd><select class="form-control input-sm" id="car_gongchang" name="car_gongchang" >
                                            <option value="0" <?php if ((isset($_smarty_tpl->getVariable('list')->value['car_gongchang']) ? $_smarty_tpl->getVariable('list')->value['car_gongchang'] : null)!=1){?>selected<?php }?>>机动车辆</option>
                                            <option value="1" <?php if ((isset($_smarty_tpl->getVariable('list')->value['car_gongchang']) ? $_smarty_tpl->getVariable('list')->value['car_gongchang'] : null)==1){?>selected<?php }?>>工厂车辆</option>
                                            
                                </select></dd>
	  </dl>
	  <dl class="lineD">
	    <dt>车辆类型：</dt>
	    <dd><select class="form-control input-sm" id="car_types" name="car_types" >
                                            <option value="0"  <?php if ((isset($_smarty_tpl->getVariable('list')->value['car_types']) ? $_smarty_tpl->getVariable('list')->value['car_types'] : null)!=1){?>selected<?php }?>>小轿车和奥德赛</option>
                                            <option value="1" <?php if ((isset($_smarty_tpl->getVariable('list')->value['car_types']) ? $_smarty_tpl->getVariable('list')->value['car_types'] : null)==1){?>selected<?php }?>>别克GL8和中巴车</option>
...
"/>
	  ...
	  <dl class="lineD">
	      <dt>车辆详细照片：</dt>
	      <dd>	
	      		照片一<input type="file" name="images1" value=""/><br />
	      		照片二<input type="file" name="images2" value=""/><br />
	        	照片三<input type="file" name="images3" value=""/><br />
	        	照片四<input type="file" name="images4" value=""/><br />
	        	照片五<input type="file" name="images5" value=""/><br />
	        	照片六<input type="file" name="images6" value=""/><br />
	        	照片七<input type="file" name="images7" value=""/><br />
	        	照片八<input type="file" name="images8" value=""/>
