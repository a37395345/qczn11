<?php /* Smarty version Smarty-3.0.4, created on 2014-04-24 20:15:12
         compiled from "D:\Phpserv\elsker\admincp\site\templates\elsker\operator/testimonial/list.html" */ ?>
<?php /*%%SmartyHeaderCode:26061535900505f3939-39760413%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dd32082c381c415ddd4ea30100649b2b5aecd507' => 
    array (
      0 => 'D:\\Phpserv\\elsker\\admincp\\site\\templates\\elsker\\operator/testimonial/list.html',
      1 => 1398341707,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '26061535900505f3939-39760413',
  'function' => 
  array (
  ),
...
条记录&nbsp;&nbsp;&nbsp;<?php echo $_smarty_tpl->getVariable('PAGINATION')->value;?>
  ...
  <tr>
    ...
    <th class="line_l">产品ID</th>
    <th class="line_l">产品标题</th>
    <th class="line_l">KV图片</th>
    <th class="line_l">当前评论数</th>
...
"></td>
	  	...
	  	<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['prodid']) ? $_smarty_tpl->tpl_vars['row']->value['prodid'] : null);?>
</td>
        <td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['name']) ? $_smarty_tpl->tpl_vars['row']->value['name'] : null);?>
</td>
        <td><img src="/thumb/<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['images']) ? $_smarty_tpl->tpl_vars['row']->value['images'] : null);?>
" width="100"></td>
		...
		<td><?php if ((isset($_smarty_tpl->tpl_vars['row']->value['status']) ? $_smarty_tpl->tpl_vars['row']->value['status'] : null)==1){?>正常<?php }else{ ?>冻结<?php }?></td>
	    <td>
...
';}">删除</a>
            <a href="list.php?pid=<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['pid']) ? $_smarty_tpl->tpl_vars['row']->value['pid'] : null);?>
