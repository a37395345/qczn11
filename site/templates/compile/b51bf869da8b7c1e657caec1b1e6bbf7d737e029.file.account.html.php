<?php /* Smarty version Smarty-3.0.4, created on 2015-10-24 16:09:40
         compiled from "D:\czyhqc\site\templates\elsker\operator/business/account.html" */ ?>
<?php /*%%SmartyHeaderCode:16107562b3cc4e8c2b0-48967844%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b51bf869da8b7c1e657caec1b1e6bbf7d737e029' => 
    array (
      0 => 'D:\\czyhqc\\site\\templates\\elsker\\operator/business/account.html',
      1 => 1445673232,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16107562b3cc4e8c2b0-48967844',
  'function' => 
  array (
  ),
...
" />
 <tr>
    <th style="text-align:left;">
    	...
    	优惠原因:<input type="text" name="settle_favorreason" id="settle_favorreason" size="48" /><br />
    	结账日期范围:<input type="text" name="settle_startDate" size="8" onClick="calendar.show(this);" readonly="readonly" />~~<input type="text" name="settle_endDate" size="8" onClick="calendar.show(this);" readonly="readonly" />
...
<?php }} ?>
 ...
 <tr>
    <th style="text-align:left;">
    	...
    	实际开票金额:<input type="text" name="settle_billMoney" id="settle_billMoney" size="6"/>
    	发票号码:<input type="text" name="settle_billNum" size="15"/>
    	开票日期:<input type="text" name="settle_billDate" size="16" onClick="calendar.show(this);" readonly="readonly" /><br />
    	方式:<select name="payments" id="payments">
	                  <option value="">请选择</option>
	                  <?php  $_smarty_tpl->tpl_vars['rows'] = new Smarty_Variable;
 $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('paymentslist')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" ><?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['bank_name']) ? $_smarty_tpl->tpl_vars['rows']->value['bank_name'] : null);?>
	                  ...
	                  <?php }} ?>
	              </select><input type="hidden" name="fee" id="fee" value=""/><input type="hidden" name="infact" id="infact" value="" size="5"/>
...
<div class="form2">
    ...
    <dl class="lineD">
      <dt>用车结束时间：</dt>
      <dd><?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_endDate_All']) ? $_smarty_tpl->getVariable('list')->value['paiche_endDate_All'] : null);?>
<input type="hidden" name="paiche_endDate" id="paiche_endDate" value="<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_endDate_format']) ? $_smarty_tpl->getVariable('list')->value['paiche_endDate_format'] : null);?>
" /></dd>
    </dl>
	<?php if ($_smarty_tpl->getVariable('busitype')->value=='1'||$_smarty_tpl->getVariable('busitype')->value=='2'){?>
    <dl class="lineD">
	...
	<dl class="lineD">
	    <dt>续租天数：</dt>
	    <dd><input type="text" name="addday" id="addday" size="2" />天或者续租到日期：<input type="text" name="end_Date" id="end_Date" size="12" onClick="calendar.show(this);calDay();" onblur="calDay();"/>&nbsp;&nbsp;原租赁天数：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_day']) ? $_smarty_tpl->getVariable('list')->value['paiche_day'] : null);?>
天</dd>
	</dl>
...
" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" /></dd>
	</dl>
	<dl class="lineD">
