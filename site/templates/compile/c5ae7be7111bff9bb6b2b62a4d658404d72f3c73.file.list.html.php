<?php /* Smarty version Smarty-3.0.4, created on 2014-04-09 15:24:33
         compiled from "D:\Phpserv\elsker\admincp\site\templates\elsker\operator/media/list.html" */ ?>
<?php /*%%SmartyHeaderCode:266385344f5b14d7a08-61343947%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c5ae7be7111bff9bb6b2b62a4d658404d72f3c73' => 
    array (
      0 => 'D:\\Phpserv\\elsker\\admincp\\site\\templates\\elsker\\operator/media/list.html',
      1 => 1397028028,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '266385344f5b14d7a08-61343947',
  'function' => 
  array (
  ),
...
">
    	<td><input type="checkbox" name="checkbox" id="checkbox<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['video_id']) ? $_smarty_tpl->tpl_vars['row']->value['video_id'] : null);?>
" value="<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['video_id']) ? $_smarty_tpl->tpl_vars['row']->value['video_id'] : null);?>
"></td>
	  	<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['video_id']) ? $_smarty_tpl->tpl_vars['row']->value['video_id'] : null);?>
</td>
        <td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['title']) ? $_smarty_tpl->tpl_vars['row']->value['title'] : null);?>
</td>
        <td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['video']) ? $_smarty_tpl->tpl_vars['row']->value['video'] : null);?>
</td>
	    ...
	    <td>
			<a href="modify.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['video_id']) ? $_smarty_tpl->tpl_vars['row']->value['video_id'] : null);?>
">编辑</a>
            <a href="javascript:if(confirm('是否确定删除？')){window.location.href='delete.php?uid=<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['video_id']) ? $_smarty_tpl->tpl_vars['row']->value['video_id'] : null);?>
';}">删除</a>
        </td>
 </tr>
 <?php }} ?>
