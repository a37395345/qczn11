<?php /* Smarty version Smarty-3.0.4, created on 2014-09-28 16:05:08
         compiled from "D:\Phpserv\qczn\site\templates\elsker\operator/finance/salary/list.html" */ ?>
<?php /*%%SmartyHeaderCode:135655427c134ab62d8-72740599%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6269deaedbd306e0d653bc64e349efbb1491bd65' => 
    array (
      0 => 'D:\\Phpserv\\qczn\\site\\templates\\elsker\\operator/finance/salary/list.html',
      1 => 1411891502,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '135655427c134ab62d8-72740599',
  'function' => 
  array (
  ),
...
条记录&nbsp;&nbsp;&nbsp;<?php echo $_smarty_tpl->getVariable('PAGINATION')->value;?>
    ...
    <a href="javascript:if(confirm('重新计算工资会将已经调整过的数据删除,是否确定重新计算？')){window.location.href='list.php?task=salarycreate&op=recreate&searchyear=<?php echo $_smarty_tpl->getVariable('year')->value;?>
&searchmonth=<?php echo $_smarty_tpl->getVariable('month')->value;?>
';}" class="btn_a"><span>重新计算</span></a>
    <a href="list.php?task=salarycreate" class="btn_a"><span>发放确认</span></a>
...
" class="btn_a"><span>工资计算</span></a><?php }?>
  ...
  <tr>
	...
	<th>报销</th>
	<th>其他</th>
	<th style="width:15%;align:left;">备注</th>
	<th>实发工资</th>
	<th>状态</th>
  </tr>
...
" >
  <?php }?>
	...
	<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['salary_allday']) ? $_smarty_tpl->tpl_vars['row']->value['salary_allday'] : null);?>
</td>
	<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['salary_savefuel']) ? $_smarty_tpl->tpl_vars['row']->value['salary_savefuel'] : null);?>
</td>
	...
	<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['salary_baoxiao']) ? $_smarty_tpl->tpl_vars['row']->value['salary_baoxiao'] : null);?>
</td>
	...
	<td><?php if ((isset($_smarty_tpl->tpl_vars['row']->value['salary_putout']) ? $_smarty_tpl->tpl_vars['row']->value['salary_putout'] : null)==1){?>已发放<?php }else{ ?><a href="javascript:modify(<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['salary_id']) ? $_smarty_tpl->tpl_vars['row']->value['salary_id'] : null);?>
);">调整</a><?php }?></td>
</tr>
 <?php }} ?>
 </table>
