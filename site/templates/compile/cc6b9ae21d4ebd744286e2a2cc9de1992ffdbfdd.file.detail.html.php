<?php /* Smarty version Smarty-3.0.4, created on 2019-09-30 09:03:43
         compiled from "/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/business/detail.html" */ ?>
<?php /*%%SmartyHeaderCode:20841672545d91546f25bf26-95687661%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cc6b9ae21d4ebd744286e2a2cc9de1992ffdbfdd' => 
    array (
      0 => '/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/business/detail.html',
      1 => 1569749207,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20841672545d91546f25bf26-95687661',
  'function' => 
  array (
  ),
...
</font></a>)<?php }?><span class="pc_inner"><?php echo (isset($_smarty_tpl->getVariable('list')->value['shop_name']) ? $_smarty_tpl->getVariable('list')->value['shop_name'] : null);?>
</span></div>
  <div class="form2">
  	<table width="90%" border="0" cellspacing="0" cellpadding="5" class="tbb">
  		...
  		<td colspan="2">
	  		...
	  		<td class="tdd" width="300">预计结束时间：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_endDate_All']) ? $_smarty_tpl->getVariable('list')->value['paiche_endDate_All'] : null);?>
</td>
	  		<td class="tdd" width="90">调度人：<?php echo (isset($_smarty_tpl->getVariable('list')->value['jiedaiyuan']) ? $_smarty_tpl->getVariable('list')->value['jiedaiyuan'] : null);?>
</td>
	  		<td class="tdd">实际车辆还车时间：<?php echo (isset($_smarty_tpl->getVariable('list')->value['settle_endDate']) ? $_smarty_tpl->getVariable('list')->value['settle_endDate'] : null);?>
</td>
	  		</tr>
	  		<tr>
...
<?php }?><?php }?></td>
	  		<td class="tdd">业务员：<?php echo (isset($_smarty_tpl->getVariable('list')->value['yewuyuan']) ? $_smarty_tpl->getVariable('list')->value['yewuyuan'] : null);?>
</td>
...
<?php }?><?php if ($_smarty_tpl->getVariable('busitype')->value=='2'&&(isset($_smarty_tpl->getVariable('list')->value['paiche_route']) ? $_smarty_tpl->getVariable('list')->value['paiche_route'] : null)!=''){?>路程：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_route']) ? $_smarty_tpl->getVariable('list')->value['paiche_route'] : null);?>
程<?php }?></td>
	  		</tr>
	  		<tr>
...
?><font style="TEXT-DECORATION: line-through;"><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['changeroute_lineA']) ? $_smarty_tpl->tpl_vars['row']->value['changeroute_lineA'] : null);?>
</font>&nbsp;&nbsp;——>&nbsp;&nbsp;<?php }} ?><?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_line']) ? $_smarty_tpl->getVariable('list')->value['paiche_line'] : null);?>
...
"<?php }else{ ?>src=""<?php }?>></td>
	  		<td width="100" class="tdd">联系人：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_linker_hid']) ? $_smarty_tpl->getVariable('list')->value['paiche_linker_hid'] : null);?>
</td>
	  		<td width="160" class="tdd">联系人手机：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_linkerPhone_hid']) ? $_smarty_tpl->getVariable('list')->value['paiche_linkerPhone_hid'] : null);?>
</td>
...
"<?php }else{ ?>src=""<?php }?>></td>
	  		<td width="100" class="tdd">担保人：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_promier']) ? $_smarty_tpl->getVariable('list')->value['paiche_promier'] : null);?>
</td>
	  		<td width="160" class="tdd">担保人手机：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_promierPhone']) ? $_smarty_tpl->getVariable('list')->value['paiche_promierPhone'] : null);?>
</td>
	  		</tr>
	  		<tr>
...
<?php }else{ ?>未使用<?php }?></td>
	  		<td width="260" class="tdd" colspan="2">联系人身份证：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_linkerNum_hid']) ? $_smarty_tpl->getVariable('list')->value['paiche_linkerNum_hid'] : null);?>
</td>
	  		<td width="260" class="tdd" colspan="2">担保人身份证：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_promierNum']) ? $_smarty_tpl->getVariable('list')->value['paiche_promierNum'] : null);?>
</td>
	  		</tr>
	  		<tr>
	  		<td ><?php if ((isset($_smarty_tpl->getVariable('list')->value['paiche_status']) ? $_smarty_tpl->getVariable('list')->value['paiche_status'] : null)==-1&&(isset($_smarty_tpl->getVariable('list')->value['settle_vioreason']) ? $_smarty_tpl->getVariable('list')->value['settle_vioreason'] : null)!=''){?>违约原因：<?php echo (isset($_smarty_tpl->getVariable('list')->value['settle_vioreason']) ? $_smarty_tpl->getVariable('list')->value['settle_vioreason'] : null);?>
<?php }?></td>
	  		<td width="260" class="tdd" colspan="2">联系人地址：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_linkerAdd']) ? $_smarty_tpl->getVariable('list')->value['paiche_linkerAdd'] : null);?>
</td>
	  		<td width="260" class="tdd" colspan="2">担保人地址：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_promierAdd']) ? $_smarty_tpl->getVariable('list')->value['paiche_promierAdd'] : null);?>
</td>
	  		</tr>
...
</td><td width="160" class="tdd">联系人手机：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_linkerPhone_hid']) ? $_smarty_tpl->getVariable('list')->value['paiche_linkerPhone_hid'] : null);?>
</td>
...
<?php }?></td>
	  		<td class="tdd"><?php if ($_smarty_tpl->getVariable('busitype')->value=='1'){?>担保人：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_promier']) ? $_smarty_tpl->getVariable('list')->value['paiche_promier'] : null);?>
<?php }?></td><td class="tdd"><?php if ($_smarty_tpl->getVariable('busitype')->value=='1'){?>担保人手机：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_promierPhone']) ? $_smarty_tpl->getVariable('list')->value['paiche_promierPhone'] : null);?>
<?php }?>&nbsp;</td>
	  		<td class="tdd"><?php if ($_smarty_tpl->getVariable('busitype')->value=='1'){?>担保人身份证：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_promierNum']) ? $_smarty_tpl->getVariable('list')->value['paiche_promierNum'] : null);?>
<?php }?>&nbsp;</td><td ><?php if ($_smarty_tpl->getVariable('busitype')->value=='1'){?>担保人地址：<?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_promierAdd']) ? $_smarty_tpl->getVariable('list')->value['paiche_promierAdd'] : null);?>
<?php }?>&nbsp;</td>
	  		</tr>
	  		</table>
	  	<?php }?>
...
if ($_smarty_tpl->_count($_from) > 0){
 ...
 $_smarty_tpl->tpl_vars['i']->value = $_smarty_tpl->tpl_vars['row']->key;
?>
	  		<?php if ((isset($_smarty_tpl->tpl_vars['row']->value['charge_name']) ? $_smarty_tpl->tpl_vars['row']->value['charge_name'] : null)!='押金'||$_smarty_tpl->getVariable('busitype')->value==1||$_smarty_tpl->getVariable('busitype')->value==3){?>
	  		<tr>
	  		...
	  		<td><?php if ((isset($_smarty_tpl->tpl_vars['row']->value['have_freeze_money']) ? $_smarty_tpl->tpl_vars['row']->value['have_freeze_money'] : null)>0){?>已冻结：<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['have_freeze_money']) ? $_smarty_tpl->tpl_vars['row']->value['have_freeze_money'] : null);?>
<?php }?>
	  			<?php if ((isset($_smarty_tpl->tpl_vars['row']->value['back_money']) ? $_smarty_tpl->tpl_vars['row']->value['back_money'] : null)>0&&(isset($_smarty_tpl->tpl_vars['row']->value['have_back_money']) ? $_smarty_tpl->tpl_vars['row']->value['have_back_money'] : null)>0){?>已退：<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['have_back_money']) ? $_smarty_tpl->tpl_vars['row']->value['have_back_money'] : null);?>
<?php }?>
	  			<?php if (((isset($_smarty_tpl->tpl_vars['row']->value['charge_name']) ? $_smarty_tpl->tpl_vars['row']->value['charge_name'] : null)=='续租金'||(isset($_smarty_tpl->tpl_vars['row']->value['charge_name']) ? $_smarty_tpl->tpl_vars['row']->value['charge_name'] : null)=='租金')&&(isset($_smarty_tpl->tpl_vars['row']->value['continuerent_start']) ? $_smarty_tpl->tpl_vars['row']->value['continuerent_start'] : null)!=''){?><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['continuerent_start']) ? $_smarty_tpl->tpl_vars['row']->value['continuerent_start'] : null);?>
...
<?php }?></td>
		    ...
		    <tr>
			    ...
			    <td><?php if ((isset($_smarty_tpl->getVariable('list')->value['paiche_shuntline']['shunt_money']) ? $_smarty_tpl->getVariable('list')->value['paiche_shuntline']['shunt_money'] : null)!=0){?>已结:<?php echo -1*(isset($_smarty_tpl->getVariable('list')->value['paiche_shuntline']['shunt_money']) ? $_smarty_tpl->getVariable('list')->value['paiche_shuntline']['shunt_money'] : null);?>
<?php }?></td>
...
元</td>
    		...
    		<tr>
	  		...
	  		<td><?php echo (isset($_smarty_tpl->getVariable('list')->value['settle_waitTimeMoney_have']) ? $_smarty_tpl->getVariable('list')->value['settle_waitTimeMoney_have'] : null);?>
</td>
	  		<td></td>
	  		</tr>
    		<?php }?>
...
?>
			  <tr>
					...
					<?php }else{ ?>
					<td><?php echo -1*(isset($_smarty_tpl->getVariable('list')->value['shunt_money']) ? $_smarty_tpl->getVariable('list')->value['shunt_money'] : null);?>
</td>
					<td>&nbsp;</td>
					<?php }?>
				  	<?php }else{ ?>
...
?>
			  <tr >
					...
					<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['changeroute_endDateA']) ? $_smarty_tpl->tpl_vars['row']->value['changeroute_endDateA'] : null);?>
</td>
					...
					<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['changeroute_endDateB']) ? $_smarty_tpl->tpl_vars['row']->value['changeroute_endDateB'] : null);?>
</td>
...
?>
			  <tr>
					...
					<td><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['settle_billFavor']) ? $_smarty_tpl->tpl_vars['row']->value['settle_billFavor'] : null);?>
</td>
...
元</td>
			  	...
			  	<?php }else{ ?>
					...
					<td><?php echo (isset($_smarty_tpl->getVariable('list')->value['settle_totalcalKm']) ? $_smarty_tpl->getVariable('list')->value['settle_totalcalKm'] : null);?>
</td>
				    <td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
			 ...
			 <tr>
			  	...
			  	<td><?php echo (isset($_smarty_tpl->getVariable('list')->value['settle_totalKm']) ? $_smarty_tpl->getVariable('list')->value['settle_totalKm'] : null);?>
</td>
			 </tr>
			 <?php }?>
			</table>
