<?php /* Smarty version Smarty-3.0.4, created on 2014-04-15 20:42:37
         compiled from "D:\Phpserv\elsker\admincp\site\templates\elsker\operator/message/list/create.html" */ ?>
<?php /*%%SmartyHeaderCode:15251534d293da39a46-04633774%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dbb79d4a5660133a362bbde21976fbc525629f5b' => 
    array (
      0 => 'D:\\Phpserv\\elsker\\admincp\\site\\templates\\elsker\\operator/message/list/create.html',
      1 => 1397565752,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15251534d293da39a46-04633774',
  'function' => 
  array (
  ),
...
" <?php if ((isset($_smarty_tpl->tpl_vars['rows']->value['message_cate_id']) ? $_smarty_tpl->tpl_vars['rows']->value['message_cate_id'] : null)==(isset($_smarty_tpl->getVariable('list')->value['message_cate_id']) ? $_smarty_tpl->getVariable('list')->value['message_cate_id'] : null)){?>selected<?php }else{ ?><?php }?>><?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['title']) ? $_smarty_tpl->tpl_vars['rows']->value['title'] : null);?>
</option>    
        <?php }} ?>
        </select>
      </dd>
...
" /> *
      ...
      <dt>答案：</dt>
      <dd>
          <textarea name="content1" style="width:700px;height:400px;visibility:hidden;"><?php echo (isset($_smarty_tpl->getVariable('list')->value['content']) ? $_smarty_tpl->getVariable('list')->value['content'] : null);?>
</textarea><br />*备注：字号大小：24PX、粗体；字体颜色：白色；字体：APP端直接用方正准圆简体
	  </dd>
    </dl>
...
"/>-->
  ...
  <input type="hidden" name="uid" value="<?php echo (isset($_smarty_tpl->getVariable('list')->value['message_id']) ? $_smarty_tpl->getVariable('list')->value['message_id'] : null);?>
" />
...
<script type="text/javascript">
	...
	function check(_form){
        if(_form.message_cate_id.value=="-请选择-"){
            alert("请选择资讯类别!");
            _form.message_cate_id.focus();
            return false;
        }
