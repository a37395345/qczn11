<?php /* Smarty version Smarty-3.0.4, created on 2020-03-18 17:11:45
         compiled from "D:\WWW\qczn\site\templates\elsker\operator/daijia_linshi/xuzhu.html" */ ?>
<?php /*%%SmartyHeaderCode:309905e71e5d15bfcc6-46748694%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1ebc5e2ec43dde5e261e52ef4d5ba3c5282f2978' => 
    array (
      0 => 'D:\\WWW\\qczn\\site\\templates\\elsker\\operator/daijia_linshi/xuzhu.html',
      1 => 1584522700,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '309905e71e5d15bfcc6-46748694',
  'function' => 
  array (
  ),
...
<div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="ibox float-e-margins">
		...
		<form method="post" action="index.php?task=xuzhu_action" name="form1" id="form1">
								...
								<div class="shiji">
									...
									<tr>
										<th style="background-color:#F5F5F6" width="15%">
											<span style="color:#000">续租开始时间：</span>
										</th>
										<td width="35%">
											<input name="paiche_startDate" id="paiche_startDate" placeholder="请输入日期" class="form-control input-sm" value="<?php echo (isset($_smarty_tpl->getVariable('paiche')->value['paiche_endDate']) ? $_smarty_tpl->getVariable('paiche')->value['paiche_endDate'] : null);?>
" readonly="readonly" unselectable="on">
									...
									<tr>
										<th style="background-color:#F5F5F6" width="15%">
											<span style="color:#000">续租结束时间：</span>
										</th>
										<td width="35%">
										...
										<th style="background-color:#F5F5F6" width="15%">
											<span style="color:#000">使用小时：</span>
										</th>
										<td width="35%">
									...
									<tr>
										<th style="background-color:#F5F5F6" width="15%">
											<span style="color:#000">续租金：</span>
										</th>

			<td width="35%">
			<input onkeyup='value=value.replace(/[^A-Za-z0-9\.]+/g,"")' type="number" min="0" class="form-control input-sm" placeholder="" id="conv_money" onchange='' name="conv_money"  >
			</td>
										...
										<td width="35%">
											<input  type="number" min="0" class="form-control input-sm" placeholder="" id="suijin" name="suijin" readonly="readonly" unselectable="on" >
										</td>
										<?php }else{ ?>
										<th style="background-color:#F5F5F6" width="15%">
										</th>
...
function jisuan_shijian(){
	...
	var xdd1 = moment(startTime).add(tian*1, 'hours').add(yue*1, 'days').format('YYYY-MM-DD HH:mm:ss'); 
...
$("#conv_money").change(function(){
	let conv_money = parseInt($("#conv_money").val());
	$("#suijin").val((conv_money*0.1).toFixed(2));
})
</script>
<!-->
</html>