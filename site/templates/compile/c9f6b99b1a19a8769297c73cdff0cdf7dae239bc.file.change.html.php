<?php /* Smarty version Smarty-3.0.4, created on 2016-08-20 13:44:38
         compiled from "D:\web\site\templates\elsker\operator/finance/change/change.html" */ ?>
<?php /*%%SmartyHeaderCode:2400257b7ee46e62ff1-12199215%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c9f6b99b1a19a8769297c73cdff0cdf7dae239bc' => 
    array (
      0 => 'D:\\web\\site\\templates\\elsker\\operator/finance/change/change.html',
      1 => 1471671876,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2400257b7ee46e62ff1-12199215',
  'function' => 
  array (
  ),
...
<body>
<div class="so_main">
  <div class="page_tit">资金账户变动/划拨</div>  
  <form method="post" action="list.php" onsubmit="return change_check(this)" name="form1">
  <div class="form2">
	  	<dl class="lineD">
		  <dt>进账时间：</dt>
...
" readonly="readonly"/></dd>
		...
		<dl class="lineD">
			<dt>付款方式：</dt>
			<dd><select name="payments_from" id="payments_from">
