<?php /* Smarty version Smarty-3.0.4, created on 2015-09-06 15:19:02
         compiled from "D:\czyhqc\site\templates\elsker\operator/maint/create.html" */ ?>
<?php /*%%SmartyHeaderCode:2406955ebe8e68d7f56-71912589%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eb97353c4239ea689605539d4643a6dc0236bf6e' => 
    array (
      0 => 'D:\\czyhqc\\site\\templates\\elsker\\operator/maint/create.html',
      1 => 1441517792,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2406955ebe8e68d7f56-71912589',
  'function' => 
  array (
  ),
...
"/>公里</dd>
	  ...
	  <dl class="lineD">
	    <dt>变速箱油保养内容：</dt>
	    <dd><textarea name="maintenance_transmission" cols="90" rows="3"><?php echo (isset($_smarty_tpl->getVariable('list')->value['maintenance_transmission']) ? $_smarty_tpl->getVariable('list')->value['maintenance_transmission'] : null);?>
</textarea></dd>
	  </dl>
	  <dl class="lineD">
	    <dt>皮带保养内容：</dt>
	    <dd><textarea name="maintenance_belt" cols="90" rows="3"><?php echo (isset($_smarty_tpl->getVariable('list')->value['maintenance_belt']) ? $_smarty_tpl->getVariable('list')->value['maintenance_belt'] : null);?>
</textarea></dd>
	  </dl>
	  <dl class="lineD">
	    <dt>发动机变速箱轮胎保养内容：</dt>
	    <dd><textarea name="maintenance_engine" cols="90" rows="3"><?php echo (isset($_smarty_tpl->getVariable('list')->value['maintenance_engine']) ? $_smarty_tpl->getVariable('list')->value['maintenance_engine'] : null);?>
</textarea></dd>
	  </dl>
	  <dl class="lineD">
	    <dt>更换：</dt>
	    <dd><input type="checkbox" value="1" name="maintenance_changebattery" <?php if ((isset($_smarty_tpl->getVariable('list')->value['maintenance_changebattery']) ? $_smarty_tpl->getVariable('list')->value['maintenance_changebattery'] : null)==1){?>checked<?php }?>/>更换电瓶&nbsp;&nbsp;<input type="checkbox" value="1" name="maintenance_changeantifreeze" <?php if ((isset($_smarty_tpl->getVariable('list')->value['maintenance_changeantifreeze']) ? $_smarty_tpl->getVariable('list')->value['maintenance_changeantifreeze'] : null)==1){?>checked<?php }?>/>更换防冻液&nbsp;&nbsp;<input type="checkbox" value="1" name="maintenance_changebrakefluid" <?php if ((isset($_smarty_tpl->getVariable('list')->value['maintenance_changebrakefluid']) ? $_smarty_tpl->getVariable('list')->value['maintenance_changebrakefluid'] : null)==1){?>checked<?php }?>/>更换刹车油 </dd>
	  </dl>
