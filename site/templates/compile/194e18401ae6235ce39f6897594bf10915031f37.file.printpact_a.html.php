<?php /* Smarty version Smarty-3.0.4, created on 2020-03-20 16:09:27
         compiled from "D:\WWW\qczn\site\templates\elsker\operator/zijia_linshi/printpact_a.html" */ ?>
<?php /*%%SmartyHeaderCode:126035e747a37a24c06-43508825%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '194e18401ae6235ce39f6897594bf10915031f37' => 
    array (
      0 => 'D:\\WWW\\qczn\\site\\templates\\elsker\\operator/zijia_linshi/printpact_a.html',
      1 => 1584691248,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '126035e747a37a24c06-43508825',
  'function' => 
  array (
  ),
...
<link href="../../../css/zijia.css?a=1" rel="stylesheet" type="text/css" />
...
{   
  document.body.innerHTML=document.getElementById('iepage1').innerHTML+'<br/><br/><br/>'+document.getElementById('iepage2').innerHTML;
...
<div class="iepage1 print" id="iepage1" style="height: 1800px;width:1170px">
<!--startprint1-->
<div style="width:125px;height:45px;position:relative;left: 85%;top: 20px">
  <img src="../../../css/logo.png" width="145px" height="50" border="0">
</div>

<h1 style="text-align: center;margin: 0">租 车 合 同 </h1>
<p style="line-height:0px;font-size: 21px;"><b>合同号：</b><?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_contractNum']) ? $_smarty_tpl->getVariable('list')->value['paiche_contractNum'] : null);?>
</p>
<table border="1" cellspacing="0" cellpadding="0" width="100%" class="table" style="text-align:center;border:#c4c4c4 solid 1px;line-height:0px;font-size: 22px;">
  <tr>
    <td>甲方</td>
  ...
  <tr>
    ...
    <td><p>承租人</p></td>
    <td colspan=""><p><?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_linker']) ? $_smarty_tpl->getVariable('list')->value['paiche_linker'] : null);?>
</p></td>
...
<p style="line-height:0px;font-size: 21px;">一．租赁车辆 </p>
...
<p style="line-height:0px;font-size: 21px;">二．租赁期限 </p>
<table border="1" cellspacing="0" cellpadding="0" width="100%" class="table" style="text-align:center;border:#c4c4c4 solid 1px;line-height:0px;font-size: 19px;">
  <tr>
    <td>起始时间</td>
...
<?php }?>
  ...
  ，每日限行驶里程为:<?php echo (isset($_smarty_tpl->getVariable('list')->value['plan_chaokms']) ? $_smarty_tpl->getVariable('list')->value['plan_chaokms'] : null);?>
公里，超公里按每公里<?php echo (isset($_smarty_tpl->getVariable('list')->value['plan_chaokmy']) ? $_smarty_tpl->getVariable('list')->value['plan_chaokmy'] : null);?>
元/公里计算，
  <?php }else{ ?>
  不限公里数，
  <?php }?>

  租赁时间以连续租用24小时为一天，超过前述终止时间的，按<?php echo (isset($_smarty_tpl->getVariable('list')->value['plan_chaoshi']) ? $_smarty_tpl->getVariable('list')->value['plan_chaoshi'] : null);?>
元每小时计收超时费用（超时半小时内不计算，超半小时不满一小时按半小时计算，超一小时不满一个半小时按一小时计算） <br />
...
?>
    <?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['charge_name']) ? $_smarty_tpl->tpl_vars['rows']->value['charge_name'] : null);?>
:<?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['conv_money']) ? $_smarty_tpl->tpl_vars['rows']->value['conv_money'] : null);?>
元，
  <?php }} ?>
...
if ($_smarty_tpl->_count($_from) > 0){
 ...
 $_smarty_tpl->tpl_vars['i']->value = $_smarty_tpl->tpl_vars['rows']->key;
?>
    <?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['youhui_name']) ? $_smarty_tpl->tpl_vars['rows']->value['youhui_name'] : null);?>
:<?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['youhui_mone']) ? $_smarty_tpl->tpl_vars['rows']->value['youhui_mone'] : null);?>
元，
  <?php }} ?>


  在租车时一次性缴付给甲方。还车时，在车辆完好无损的情况下与甲方结算，结算时<font style="font-family : 微软雅黑,宋体;text-decoration:underline;"><strong>
  甲方要暂扣违章保证金3000元，若无违章费用则在30天后退回。所有违章由本公司统一处理，结算方式为：违章费用+50%违章手续费+<?php if ((isset($_smarty_tpl->getVariable('list')->value['car_types']) ? $_smarty_tpl->getVariable('list')->value['car_types'] : null)<=4){?>150<?php }else{ ?>250<?php }?>元/分，结算时间为银行营业时间内。 </strong></font> <br />
...
，若超出范围，租车公司有权前往收车，押金不退！收车费另行结算，由承租人承担。<?php if ((isset($_smarty_tpl->getVariable('list')->value['paiche_needtax']) ? $_smarty_tpl->getVariable('list')->value['paiche_needtax'] : null)==0){?>此次租车无需要开票。<?php }?>若提前还车，租金不退。还车时请清洗车辆，如若不洗，向甲方支付清洗费50元。租赁期间保管好车辆行驶证，如若丢失，赔偿500元。甲方有权从车辆押金中直接扣除前述费用。</strong></font><br />
  ...
  八．备注说明：<?php if ((isset($_smarty_tpl->getVariable('list')->value['car_remarks_b']) ? $_smarty_tpl->getVariable('list')->value['car_remarks_b'] : null)){?><?php echo (isset($_smarty_tpl->getVariable('list')->value['car_remarks_b']) ? $_smarty_tpl->getVariable('list')->value['car_remarks_b'] : null);?>
;<?php }?><?php echo (isset($_smarty_tpl->getVariable('list')->value['paiche_specialRemarks']) ? $_smarty_tpl->getVariable('list')->value['paiche_specialRemarks'] : null);?>
 <br />
  ...
  2．甲方负责向保险公司对租赁车辆投保:<?php echo (isset($_smarty_tpl->getVariable('list')->value['car_remarks_a']) ? $_smarty_tpl->getVariable('list')->value['car_remarks_a'] : null);?>
</strong></font><br/>
  ...
  <font style="font-family : 微软雅黑,宋体;text-decoration:underline;"><strong>
    8．租赁期内发生事故导致车辆需要维修的，不论有无责任，均需按照下列标准补偿甲方车辆的折旧损失：①车辆维修费在1万元以下的（含1万），按10%补偿；②车辆维修费在1万元以上5万元以下的（含5万），按20%补偿；③车辆维修费在5万元以上的，按30%补偿；④车辆维修应在甲方认可的维修机构处进行维修；维修期间，乙方应继续按前述租金标准支付车辆使用费，直至车辆维修完毕；乙方未及时足额按上述租金标准支付车辆使用费的，甲方有权按上述超时费用标准向乙方收取车辆使用费；乙方应及时足额支付车辆维修费用，若乙方未及时足额支付车辆维修费用，甲方没有义务垫资进行车辆维修，由此导致维修延长期间乙方仍应按前述约定支付车辆使用费。
  </strong></font><br/>
...
<!--------------第二页------------------------>
<div class="iepage2 print" id="iepage2" style="height: 1400px;width: 1170px">
...
<p style="font-size: 18px">
  ...
  8．其他应由乙方承担的相关费用。<br />
  十二．其他： <br />
  1．在合同期内如遇国家重大经济政策变化，或一方遇到不可抗力，经甲乙双方协商，可对合同条款作适当调整。<br />2．合同的附件是本合同的组成部分，与本合同具有同等法律效力。 <br />3．如发生纠纷，由甲乙双方协商解决，协商不成，提交常州市武进区人民法院诉讼。<br />
