<?php /* Smarty version Smarty-3.0.4, created on 2019-04-25 14:22:23
         compiled from "F:\WWW\qczn\site\templates\elsker\operator/renshi/tianjia.html" */ ?>
<?php /*%%SmartyHeaderCode:110775cc1521f9f6d45-70291496%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3554345e1dd638bdfed18f95263de2f74f84d82b' => 
    array (
      0 => 'F:\\WWW\\qczn\\site\\templates\\elsker\\operator/renshi/tianjia.html',
      1 => 1556171788,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '110775cc1521f9f6d45-70291496',
  'function' => 
  array (
  ),
...
<body>
<div class="so_main">
  <div class="page_tit"><?php if ($_smarty_tpl->getVariable('op')->value=='update'){?>修改职位<?php }else{ ?>添加职位<?php }?></div>
  
  <form method="post" action="add.php" enctype="multipart/form-data" onsubmit="return check(this)">
  <div class="form2">
    <dl class="lineD">
