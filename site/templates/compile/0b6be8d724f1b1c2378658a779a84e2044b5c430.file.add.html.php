<?php /* Smarty version Smarty-3.0.4, created on 2019-09-30 10:09:38
         compiled from "/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/emp/add.html" */ ?>
<?php /*%%SmartyHeaderCode:6941468675d9163e20ea297-67744948%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0b6be8d724f1b1c2378658a779a84e2044b5c430' => 
    array (
      0 => '/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/emp/add.html',
      1 => 1569749212,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6941468675d9163e20ea297-67744948',
  'function' => 
  array (
  ),
...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="ibox float-e-margins">
            ...
            <form method="post" action="index.php?task=insert" name="form1" enctype="multipart/form-data">
            <div class="ibox-content">
                <div class="row row-lg">
                    ...
                    <table class="table table-bordered">
                        <tr style="display: none" id="tupian">
                            <th style="background-color:#F5F5F6" width="15%">
                                <span style="color:#000">图片</span>
                            </th>
                            <td width="35%">
                                <img id="image" src="" style="width: 25%">
                            </td>
                            <input type="hidden" name="emp_imagea" id="emp_imagea">
                        ...
                        <tr>
                            ...
                            <td width="35%">
                               <input type="text" id="emp_name" name="emp_name"  class="form-control input-sm" placeholder="必填" readonly="readonly" unselectable="on">
                            </td>
                            <th style="background-color:#F5F5F6" width="15%">
                                <span style="color:#000">身份证号码：</span>
                            </th>
                            <td width="35%">
                               <input type="text" id="emp_num" name="emp_num"  class="form-control input-sm" placeholder="必填" minlength="18" maxlength="18" readonly="readonly" unselectable="on">
                            </td>
                        ...
                        <tr>
                            <th style="background-color:#F5F5F6" width="15%">
                             ...
                             <td width="35%">
                                <input type="text" id="emp_homeAdd" name="emp_homeAdd"  class="form-control input-sm" placeholder="必填">
                            ...
                            <td width="35%">
                               <input type="text" id="emp_phone" name="emp_phone"  class="form-control input-sm" placeholder="必填" minlength="11" maxlength="11">
                            </td>
                        </tr>
                        ...
                        <tr>
                             ...
                             <td width="35%">
                                <input type="text" id="dangqian_homeAdd" name="dangqian_homeAdd"  class="form-control input-sm" placeholder="必填" >
                        ...
                        <tr>
                            <th style="background-color:#F5F5F6" width="15%">
                                <span style="color:#000">紧急联系人：</span>
                            </th>

                            <td width="35%">
                               <input type="text" id="jinji_name" name="jinji_name"  class="form-control input-sm" placeholder="必填" >
                            </td>
                            <th style="background-color:#F5F5F6" width="15%">
                                <span style="color:#000">紧急联系人电话：</span>
                            </th>
                            <td width="35%">
                               <input type="text" id="jinji_phone" name="jinji_phone"  class="form-control input-sm" placeholder="必填" minlength="11" maxlength="11">
                            </td>
                        ...
                        <tr>
                            ...
                            <th style="background-color:#F5F5F6" width="15%">
                             ...
                             <td width="35%">
                                <input type="text" id="emp_kahao" name="emp_kahao"  class="form-control input-sm" placeholder="" minlength="16" maxlength="19">
                            </td>
                             <th style="background-color:#F5F5F6" width="15%">
                        ...
                        <tr>
                            <th style="background-color:#F5F5F6" width="15%">
                                <span style="color:#000">所属职位：</span>
                            </th>
                            <td width="35%">
                               <select class="form-control input-sm" name="emp_zhiweiid" id="emp_shopid">
...
"><?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['zhiwei_name']) ? $_smarty_tpl->tpl_vars['rows']->value['zhiwei_name'] : null);?>
                            ...
                            <th style="background-color:#F5F5F6" width="15%">
                             ...
                             <td width="35%">
                                 <select class="form-control input-sm" name="emp_shopid" id="emp_shopid">
                                                    <option value="0">请选择</option>
                                                <?php  $_smarty_tpl->tpl_vars['rows'] = new Smarty_Variable;
 $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable;
...
"><?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['shop_name']) ? $_smarty_tpl->tpl_vars['rows']->value['shop_name'] : null);?>
                        ...
                        <tr>
                                    ...
                                    <td width="35%">
                                        ...
                                        <input name="emp_addtime"  id="emp_addtime" placeholder="请输入日期" value="" class="laydate-icon" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" unselectable="on" readonly>
                                    </td>
                                    ...
                                    <th style="background-color:#F5F5F6" width="15%">
                                     ...
                                     <td width="35%">
                                        <input type="text" id="emp_workTel" name="emp_workTel"  class="form-control input-sm" placeholder="" minlength="11" maxlength="11">
                                    </td>
                            ...
                            <tr>
                                    ...
                                    <td width="35%">
                                        <input name="emp_pactStartDate"  id="emp_pactStartDate" placeholder="请输入日期" value="" class="laydate-icon" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" unselectable="on" readonly>
                                    </td>
                                    ...
                                    <td width="35%">
                                        <input name="emp_pactEndDate"  id="emp_pactEndDate" placeholder="请输入日期" value="" class="laydate-icon" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" unselectable="on" readonly>
                                    </td>
                        ...
                        <tr>
                            ...
                            <td width="35%">
                               <input type="text" id="zemp_butie" name="zemp_butie"  class="form-control input-sm" placeholder="">
                            </td>
                             <th style="background-color:#F5F5F6" width="15%">
                            ...
                            <td width="35%">
                                        <label style="margin:0px;margin-right: 10px">
                                            <input name="zemp_anquan" type="radio"  value="1"/ 
                                             style="display: block;float: left;margin: 3px;padding: 0"> 
                                            <span style="display: block;float: left;">有</span> 
                                        </label>

                                        <label style="margin:0px;margin-right: 10px">
                                            <input name="zemp_anquan" type="radio" checked value="0"  
                                             style="display: block;float: left;margin: 3px;padding: 0">
                            ...
                            <td width="35%">
                               <input type="text" id="emp_driverlicense" name="emp_driverlicense"  class="form-control input-sm" placeholder="">
                            </td>
                            <th style="background-color:#F5F5F6" width="15%">
                                        <span style="color:#000">驾照有效日期：</span>
                                    </th>
                                    <td width="35%">
                                        <input name="emp_jiazhaotime"  id="emp_jiazhaotime" placeholder="请输入日期" value="" class="laydate-icon" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" unselectable="on" readonly>
                                    </td>
                            ...
                            <tr>
                                ...
                                <td width="35%">
                                        <input type="text" id="emp_introduce" name="emp_introduce"  class="form-control input-sm" placeholder="">
                                </td>
                                    <th style="background-color:#F5F5F6" width="15%">
