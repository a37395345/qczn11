<?php /* Smarty version Smarty-3.0.4, created on 2015-11-12 17:45:30
         compiled from "D:\web\site\templates\elsker\operator/finance/salary/create.html" */ ?>
<?php /*%%SmartyHeaderCode:2467356445fbaa31fb7-39803389%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5f70e6a5bf872dc236cef9c0d89ca1797f89015b' => 
    array (
      0 => 'D:\\web\\site\\templates\\elsker\\operator/finance/salary/create.html',
      1 => 1447321370,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2467356445fbaa31fb7-39803389',
  'function' => 
  array (
  ),
...
" /></dd>
		...
		<dl class="lineD">
		  <dt><span class="redstar">*</span>趟数补贴：</dt>
		  <dd><input type="text" name="salary_tssubsid" id="salary_tssubsid" size="4" value="<?php echo (isset($_smarty_tpl->getVariable('list')->value['salary_tssubsid']) ? $_smarty_tpl->getVariable('list')->value['salary_tssubsid'] : null);?>
" /></dd>
		</dl>
		<dl class="lineD">
...
" onFocus="this.blur()" /></dd>
		...
		<dl class="lineD">
		  <dt>请假天数：</dt>
		  <dd><?php echo (isset($_smarty_tpl->getVariable('list')->value['salary_leave']) ? $_smarty_tpl->getVariable('list')->value['salary_leave'] : null);?>
</dd>
		</dl>
		<dl class="lineD">
		  <dt>请假扣款：</dt>
		  <dd><?php echo (isset($_smarty_tpl->getVariable('list')->value['salary_leavemoney']) ? $_smarty_tpl->getVariable('list')->value['salary_leavemoney'] : null);?>
<input type="hidden" name="salary_leavemoney" id="salary_leavemoney" value="<?php echo (isset($_smarty_tpl->getVariable('list')->value['salary_leavemoney']) ? $_smarty_tpl->getVariable('list')->value['salary_leavemoney'] : null);?>
" /> </dd>
		</dl>
		<dl class="lineD">
		  <dt><span class="redstar">*</span>迟到扣款：</dt>
		  <dd><input type="text" name="salary_latemoney" id="salary_latemoney" size="4" value="<?php echo (isset($_smarty_tpl->getVariable('list')->value['salary_latemoney']) ? $_smarty_tpl->getVariable('list')->value['salary_latemoney'] : null);?>
" /></dd>
		</dl>
		<dl class="lineD">
...
function calTotal(){
	var should=0;
	should=parseFloat($("#salary_base").val())
			+($('#salary_social').val()=="" ? 0 : parseFloat($('#salary_social').val()))
			+($('#salary_kmsubsid').val()=="" ? 0 : parseFloat($('#salary_kmsubsid').val()))
			+($('#salary_ovkmsubsid').val()=="" ? 0 : parseFloat($('#salary_ovkmsubsid').val()))
			+($('#salary_tssubsid').val()=="" ? 0 : parseFloat($('#salary_tssubsid').val()))
	...
	should=should-parseFloat($('#salary_leavemoney').val())-($('#salary_latemoney').val()=="" ? 0 : parseFloat($('#salary_latemoney').val()))
			-($('#salary_borrow').val()=="" ? 0 : parseFloat($('#salary_borrow').val()))
