<?php /* Smarty version Smarty-3.0.4, created on 2015-04-30 15:55:15
         compiled from "D:\czyhqc\site\templates\elsker\operator/employee/sijilist.html" */ ?>
<?php /*%%SmartyHeaderCode:278765541dfe3c2cd39-11862466%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3bba8b78d655b067b4aab35e9487432e2011e78d' => 
    array (
      0 => 'D:\\czyhqc\\site\\templates\\elsker\\operator/employee/sijilist.html',
      1 => 1430379450,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '278765541dfe3c2cd39-11862466',
  'function' => 
  array (
  ),
...
" width="50" height="70" /><?php }?></a>
	...
	<tr>
		...
		<?php if ((isset($_smarty_tpl->tpl_vars['row']->value['paiche_list']) ? $_smarty_tpl->tpl_vars['row']->value['paiche_list'] : null)==''){?>暂无出车记录<?php }else{ ?><span ><a href="../machine/carrundetail.php?emp_id=<?php echo (isset($_smarty_tpl->tpl_vars['row']->value['emp_id']) ? $_smarty_tpl->tpl_vars['row']->value['emp_id'] : null);?>
" target="blank">查看出车记录</a></span><?php }?>
		</td>
	</tr>
	</table>
	</td>
