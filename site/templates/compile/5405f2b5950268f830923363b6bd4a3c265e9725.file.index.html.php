<?php /* Smarty version Smarty-3.0.4, created on 2019-09-30 13:55:51
         compiled from "/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/jucan/index.html" */ ?>
<?php /*%%SmartyHeaderCode:9403871545d9198e731e0a4-76627496%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5405f2b5950268f830923363b6bd4a3c265e9725' => 
    array (
      0 => '/www/wwwroot/gl.czyhqc.com/site/templates/elsker/operator/jucan/index.html',
      1 => 1569749224,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9403871545d9198e731e0a4-76627496',
  'function' => 
  array (
  ),
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="ibox float-e-margins" >
            <div class="ibox-title" style="    padding-top: 5px">
                <h5 style="padding-top: 10px"">经费管理</h5>
                <div class="ibox-tools" style="margin-left: 40px;">
                    <a class="btn btn-outline btn-default" href="index.php?task=add">
...
?>
										<tr>
											...
											<td><?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['xiangmu_name']) ? $_smarty_tpl->tpl_vars['rows']->value['xiangmu_name'] : null);?>
</td>
											<td><?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['emp_name']) ? $_smarty_tpl->tpl_vars['rows']->value['emp_name'] : null);?>
</td>
                                            <td><?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['shop_name']) ? $_smarty_tpl->tpl_vars['rows']->value['shop_name'] : null);?>
</td>
											...
											<td><?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['add_emp_name']) ? $_smarty_tpl->tpl_vars['rows']->value['add_emp_name'] : null);?>
</td>
											
											<td align="center">
												<div>
													<a href="index.php?task=add&id=<?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['id']) ? $_smarty_tpl->tpl_vars['rows']->value['id'] : null);?>
" title="修改">
                                         ...
                                         <?php $_smarty_tpl->tpl_vars['money_a'] = new Smarty_variable($_smarty_tpl->getVariable('money_a')->value+(isset($_smarty_tpl->tpl_vars['rows']->value['money']) ? $_smarty_tpl->tpl_vars['rows']->value['money'] : null), null, null);?>
                                        <?php }} ?>
                                        <tr>
                                            <td colspan="9">合计：<?php echo $_smarty_tpl->getVariable('money_a')->value;?>
</td>
                                        </tr>
