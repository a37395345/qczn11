<?php /* Smarty version Smarty-3.0.4, created on 2018-11-11 16:18:02
         compiled from "D:\web\site\templates\elsker\operator/finance/baoxiao/list3.html" */ ?>
<?php /*%%SmartyHeaderCode:260285be7e5ba08e6c4-28198737%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8f215eb0783e6af5199eb02a2293b8bb706e7612' => 
    array (
      0 => 'D:\\web\\site\\templates\\elsker\\operator/finance/baoxiao/list3.html',
      1 => 1541906969,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '260285be7e5ba08e6c4-28198737',
  'function' => 
  array (
  ),
...
function winsub(){
	...
	function leadcheck(bid){
		if (bid==""){
	        ...
	        demo_iframe('list.php?task=leadcheck&uids='+bids,'费用报销领导审批',750,680,'login_js');
		}else{
			demo_iframe('list.php?task=leadcheck&uid='+bid+'&search_user='+$("input[name='search_user']:checked").val(),'费用报销领导审批',750,680,'login_js');
		}
