<?php /* Smarty version Smarty-3.0.4, created on 2019-09-23 18:52:36
         compiled from "F:\WWW\qczn\site\templates\elsker\index_a.html" */ ?>
<?php /*%%SmartyHeaderCode:193165d88a3f44b84f4-83298050%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd3d6306df4159d47b92163d763ea13852bdb552f' => 
    array (
      0 => 'F:\\WWW\\qczn\\site\\templates\\elsker\\index_a.html',
      1 => 1569235124,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '193165d88a3f44b84f4-83298050',
  'function' => 
  array (
  ),
...
" <?php if ($_smarty_tpl->getVariable('i')->value==0){?>data-index="0"<?php }?>><?php echo (isset($_smarty_tpl->tpl_vars['rows']->value['name']) ? $_smarty_tpl->tpl_vars['rows']->value['name'] : null);?>
                    ...
                    <?php }else{ ?>
                        <li>
                        <a class="J_menuItem" href="<?php echo (isset($_smarty_tpl->getVariable('rows')->value['script']) ? $_smarty_tpl->getVariable('rows')->value['script'] : null);?>
">
                            <i class="fa fa-columns"></i> <span class="nav-label"><?php echo (isset($_smarty_tpl->tpl_vars['row']->value['script']) ? $_smarty_tpl->tpl_vars['row']->value['script'] : null);?>
</span></a>
                        </li>
                    <?php }?>
                    <?php }} ?>
