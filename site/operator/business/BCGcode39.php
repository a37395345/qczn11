...
include_once('../../includes/barcode/html/include/function.php');
...
$code = "BCGcode128"; //$system_temp_array2[0];
...
$text = isset($_GET['text']) ? $_GET['text'] : $default_value['text'];
//$text="123456789";
...
<a href="#" class="info characters"></a>-->
...
?>
                  ...
                  <?php
                    ...
                    ?>
                        ...
                        <?php if ($imageKeys['text'] !== '') { ?><img src="../../includes/barcode/html/image.php<?php echo $finalRequest; ?>" alt="Barcode Image" /><?php }
